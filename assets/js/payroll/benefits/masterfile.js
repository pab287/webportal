...
var tblBenefits = $("#table-benefits").DataTable({
    dom: '<"toolbar">frtlip',
	serverSide: true,
    processing: true,
    aaSorting: [],
    ajax: {
		url: baseUrl("payroll/benefits/masterfile/"),
        type: "post",
        global: false,
        dataType: "json",
        data: function(d){
...
function Save(){
    $.validate({
      ...
      onSuccess : function(form) {
            $.ajax({
                url: baseUrl("payroll/benefits/save"),
                type: "POST",
                dataType: "json",
...
function Edit(id){
    ...
    $.ajax({
        url: baseUrl("payroll/benefits/edit/")+id,
        type: "GET",
        dataType: "json",
        success: function(data){
            $("#code").val(data.code);
            $("#name").val(data.benefit_name);
        }
    });
    ...
    $.validate({
        ...
        onSuccess : function(form) {
            $.ajax({
                url: baseUrl("payroll/benefits/update/")+id,
                type: "POST",
                dataType: "json",
...
function Archive(id){
    ...
    $.validate({
        ...
        onSuccess: function (form) {
            $.ajax({
                url: baseUrl("payroll/benefits/delete/")+id,
                type: "POST",
                dataType: "json",

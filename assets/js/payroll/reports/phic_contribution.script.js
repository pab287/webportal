...
var vmPsData = new Vue({
    ...
    methods: {
        formattedDate: function(date){
            ...
            return tempDate;
        }, formattedAdjustments(adjustment, type='phic'){
    ...
    buttons: [
        {
            ...
            title: function () {
                ...
                console.log(typeof(_tempFilter.companies));
                ...
                win.document.title = "PHIC Contribution Printable Page";
                let signatoryCells = ``;
    ...
    $.ajax({
        ...
        success: function (json) {
            ...
            if (json.response) {
                ...
                toastr.success(json.toastr_msg, "Filtered PHIC Contribution");
            } else {
                _clearTable = true;

...
var tblCategory = $("#table-category").DataTable({
    ...
    ajax: {
        url: baseUrl("ams/maintenance/get_category_collection"),
        type: "post",
        global: false,
        dataType: "json",
        data: function (d) {
...
function itemDatatableActions($id) {
    if ($id) {
        ...
        _actionButton += " <button type='button' " +
            ...
            "   data-toggle='m-tooltip' data-original-title='Delete'" +
            "   data-placement='bottom'" +
            "   data-skin='dark' data-delay='{\"show\": 300}'>" +
...
function edit_category(id) {
    ...
    $('#form_category')[0].reset();
    $.ajax({
        url: baseUrl("ams/maintenance/edit_category/") + id,
        type: "GET",
        dataType: "JSON",
...
function delete_category() {
    ...
    $.ajax({
        url: baseUrl("ams/maintenance/delete_category/") + $temp,
        type: "POST",
        dataType: "JSON",
        ...
        success: function (data) {
            ...
            toastr.success("Category was successfully deleted.", "Category Deleted.", 10000);
        },
        error: function (jqXHR, textStatus, errorThrown) {
...
function save_category() {
    ...
    let msg = null;
    if (save_method == 'add') {
        url = baseUrl("ams/maintenance/add_category/");
        msg = {
            title: "New Category",
            message: "New Category was successfully saved."
        };
    } else {
        url = baseUrl("ams/maintenance/update_category/");
        msg = {

        ...
        filterBy(val){
            ...
            if (val === 1){
                ...
                setTimeout( function (){
                    ...
                    if (instance.instanceColumn.length == 0) {
                ...
                buttons: [
                    {
                        ...
                        customize: function (xlsx) {
                            ...
                            var company = instance.generatedCompany ? instance.generatedCompany.replace(/[^\w\s]/gi, '') : 'All';
                            var department = instance.generatedDepartment ? instance.generatedDepartment.replace(/[^\w\s]/gi, '') : 'All';
                            var position = instance.generatedPosition ? instance.generatedPosition.replace(/[^\w\s]/gi, '') : 'All';
                            ...
                            console.log(company, department, position);
                            //insert

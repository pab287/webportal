...
function getCategory(){
    $.ajax({
        url: baseUrl('qms/masterfile/get_companies'),
        dataType: "json",
        success: function(json){
            ...
            setTimeout( function(){
                vmTab1.getContent(json.data[0].grouped, json.data[0].company_id);
            }, 500);
        }
    })
}
    ...
    methods: {
        getContent: function(tableId, id){
            ...
            instance.table = tabId.DataTable({
                ...
                retrieve: true,
                ajax: {
                    url: baseUrl("qms/masterfile/get_company_policy_datatable_request"),
                    type: "post",
                    dataType: "json",
                    data: function (d) {
                        d.csrf_token = _csrf_hash,
                ...
                columns: [
                    ...
                    { title: 'Departments under this document', data: "departments", width: '10%', 

...
class Googlemaps {
	...
	// var $apiKey						= 'AIzaSyCTzlKHdtvrOuKv7LEQjW8HVmy1QFFgalM';						// If you've got an API key you can use it by passing this parameter. Setup an API key here: https://code.google.com/apis/console
	// var $apiKey						= 'AIzaSyB0P6151i4JuPBG79VhRhaiEzqR4Awmnmw'; 						// If you've got an API key you can use it by passing this parameter. Setup an API key here: https://code.google.com/apis/console
	var $apiKey						= 'AIzaSyCm_pTwQzhaAKspErhW9ptpubv_ATLrpgE'; 						// If you've got an API key you can use it by passing this parameter. Setup an API key here: https://code.google.com/apis/console

<?php $crumbTitle = $this->core_layout->getCrumbTitle(); ?>
<?php $crumbHeaderTitle = $this->core_layout->getHeaderTitle(); ?>
<div class="m-subheader ">
    <div class="d-flex align-items-center">
        <div class="mr-auto">
            <h3 class="m-subheader__title m-subheader__title--separator" style="text-transform: uppercase;">
                <?php echo ($crumbTitle)? $crumbTitle: $this->router->fetch_module(); ?>
            </h3>

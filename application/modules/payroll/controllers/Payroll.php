<?php defined('BASEPATH') OR exit('No direct script access allowed');
    ...
    class Payroll extends MY_Controller {
        ...
        function set_printable_payslip() {
        ...
        function set_printable_payslip_aknowledgement() {
        ...
        function set_printable_payslip_netpay() {
      ...
      function test_email($id=77194){
        $this->payroll->testEmail($id);
      }

        function payroll_sheet_masterfile() {
        ...
        function select_incentive_type() {
        ...
        function select_employee_pssummary() {
            $data = $this->payroll->selectEmployee_payrollsummary();
            $this->output
                ->set_content_type('json')
                ->set_output(json_encode($data));
        }
        ...
        function generate_payroll_sheet_incentive($_start = null, $_end = null) {
        ...
        function get_payroll_sheet_incentive() {
            $_post = $this->input->post();
            $start = null;
            $end = null;
            $show_posted = "_all";
        ...
        function get_pay_rate_settings() {
            echo json_encode($this->payroll->getPayRateSettings());
        }

        function update_pay_rate_setting() {
        ...
        function confirm_undo_posting($payroll_sheet_id) {
        ...
        function get_payroll_history() {
            echo json_encode($this->payroll->getPayrollHistory());
        }

        function get_payroll_payslip_table_request() {
            echo json_encode($this->payroll->getPayrollPayslipTableRequest());
        }
        function get_current_payroll_payslip($id=null) {
        ...
        function update_payroll_settings() {
            $data = $this->payroll->updatePayrollSettings();
            $this->output
                ->set_content_type('json')
                ->set_output(json_encode($data));
        }
        function update_sss_contribution_basis() {
            $data = $this->payroll->updateSssContributionBasis();
            $this->output
                ->set_content_type('json')
                ->set_output(json_encode($data));
        }
        function update_zeronetpay_parameters() {
        ...
        function generate_ps_contribution(){
        ...
        function generate_employees_no_cont_acct(){
        ...
        function update_employee_company(){
            $data = $this->payroll->updateEmployeeCompany();
        }
        
        function create_signatory_content(){
        ...
        function create_printable_signatory(){
        ...
        function update_printable_signatory(){
        ...
        function get_payroll_signatory(){
        ...
        function get_current_signatory($id=null){
        ...
        function generate_payroll_summary(){
        ...
        function generate_overtime_report(){
        ...
        function get_payroll_summary_request(){
        ...
        function generate_payroll_monthly_week_count($year=null){
        ...
        function update_payrollsheet_printed_status(){

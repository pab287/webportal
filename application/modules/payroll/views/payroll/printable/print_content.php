                ...
                <div class="m-form m-form--fit m-form--label-align-right">
                    ...
                    <?php if(intval($item->is_bonus) == 0): ?>
                        ...
                        <div class="row m--margin-top-5">
                            ...
                            <div class="col-md-4 printable-width-4 text-right">
                                <!-- span class="m--font-boldest"><?php echo $item->psa_total; ?></span -->
                                <h5 class="m--font-boldest m--marginless"><?php echo $item->total_allowances; ?></h5>
                            </div>
                        </div>
                    ...
                    <?php if(intval($item->is_bonus) == 0): ?>
                        ...
                        <!-- commented out as loans must not add all up its loans -->
                        <?php //if($item->total_loans && floatval($item->total_loans) > 0): ?>
                        <!-- <div class="row text-right">
                            <div class="col-md-5 printable-width-5">
                                <h5 class="m--font-bolder m--marginless">LOANs </h5>
                            </div>
                            <div class="col-md-7 printable-width-7 text-left">
                                <h5 class="m--font-bolder m--marginless"><?php //echo $item->total_loans; ?></h5>
                            </div>
                        </div> -->
                        <?php //endif; ?>
                        <!-- commented out as loans must not add all up its loans -->
                        
                        <!-- commented out as it is for loans only -->
                        <?php //if($item->total_loans && (floatval($item->total_loans) > 0 || floatval($item->sss_loan) > 0 || floatval($item->hdmf_loan) > 0 || (is_array($item->loans) && count($item->loans) > 0))): ?>
                        <!-- commented out as it is for loans only -->
                        <?php if($item->total_loans && (floatval($item->total_loans) > 0 || (is_array($item->loans) && count($item->loans) > 0))): ?>
                            <!-- <h5 class="m--marginless"><span class="m--margin-left-15">LOANS</span></h5> -->
                            ...
                            <?php $temp_totalLoan = 0; $created_adjustment = $item->created_adjustments; ?>
                                ...
                                <div class="row text-right">
                                    <?php if($vv->amount_due > 0){ ?>
                                        ...
                                        <?php if (strtolower($vv->loan_name) != 'charges'): ?>
                                            ...
                                            <div class="col-md-7 printable-width-7 text-left">
                                                <h5 class="m--font-bolder m--marginless"><?php echo $temp_amountDue; ?></h5>
                                            </div>

                                            <?php $temp_totalLoan += floatval(preg_replace('/[^\d\.\-]/', '', $temp_amountDue)); ?>
                                        <?php endif; ?>
                                    <?php } ?>
                                </div>
                            <?php endforeach; ?>
                    ...
                    <?php // if(intval($item->is_bonus) == 0): ?>
                        <?php // if(floatval($item->deductions) > 0) { ?>
                            <!-- <div class="m-form__seperator m-form__seperator--line m-form__seperator--space-1x m--marginless"></div>
                            ...
                            <div class="row m--margin-top-5 m--margin-bottom-5">
                                ...
                                <div class="col-md-4 printable-width-4 text-right">
                                    <h5 class="m--font-boldest m--marginless">( <?php // echo $item->deductions; ?> )</h5>
                                </div>
                            </div> -->
                        <?php // } ?>
                    <?php // endif; ?>

<div class="modal-dialog modal-lg" role="document">
    <div class="modal-content">
      ...
      <form id="frmNewEmployeeGroup" class="m-form" method="post" action="<?php echo site_url("payroll/employee/set_new_payroll_employee_group"); ?>">
        ...
        <div class="form-group m-form__group row">
          ...
          <div class="col-1">
            <span class="m-switch m-switch--outline m-switch--sm m-switch--icon m-switch--success">
              <label>
                <input type="checkbox" value="1" id="active_employees" checked="checked" />
                <span></span>
              </label>
            </span>
          </div>

<template v-if="count > 0">
    <div :id="'m--portlet_append_'+index" class="m-portlet m-portlet--bordered m-portlet--head-sm m-portlet--mobile m-portlet--sortable mb-1" data-portlet="true" v-for="(item, index) in row.meta_field">

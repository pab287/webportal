            ...
            <div class="m-portlet__head-caption">
                <div class="m-portlet__head-title">
                    <h3 class="m-portlet__head-text">
                        Payroll Sheet SUMMARY <small>Report</small>
                    </h3>
                </div>
            </div>
            ...
            <div id="overtime_summary_table">
                <div class="tbl-responsive-sm">
                        ...
                        <template v-if="show_header">
                            <div class="row mb-3">
                                <div class="col-md-12 filter-title text-center">
                                    <h5>PAYROLL SHEET SUMMARY REPORT</h5>
                    ...
                    <div class="m_datatable m-datatable m-datatable--default m-datatable--loaded m-datatable--scroll">
                        <table class="table table-bordered" style="font-family: roboto; width: 100%;" id="tbl-payrollsheet-summary">
                            <thead>
                                <tr>
                                    <th class="m--hide">EMPLOYEE NAME</th>
                                    <th class="vertical-middle">DATE</th>
                                    <th class="vertical-middle">SPECIFIED DAY</th>
                                    <th class="vertical-middle">RATE</th>
                                    <th class="vertical-middle">HOURLY RATE</th>
                                    <th class="vertical-middle">TOTAL NO. OF HRS WORKED</th>
                                    <th class="vertical-middle">NO. OF HRS WORKED (REGULAR)</th>
                                    <th class="vertical-middle">NO. OF HRS WORKED (OVERTIME)</th>
                                    <th class="vertical-middle">OT RATE</th>
                                    <th class="vertical-middle">25% OT PAY</th>
                                    <th class="vertical-middle">REGULAR ND HRS WORKED</th>
                                    <th class="vertical-middle">OT ND HRS WORKED</th>
                                    <th class="vertical-middle">REGULAR NIGHT DIFF</th>
                                    <th class="vertical-middle">OT NIGHT DIFF</th>
                                    <th class="vertical-middle">AMOUNT PAID</th>
                                    <th class="vertical-middle">TOTAL PAY</th>
                                </tr>
                            </thead>
                            <tbody></tbody>
                            <tfoot>
...
<div class="modal fade" tabindex="-1" id="generate-report-modal">
    <div class="modal-dialog modal-lg">
        <div class="modal-content" id="generate-journal_content">
            ...
            <form id="frm-journal-report" method="post" action="<?php echo site_url("payroll/reports/generate_payrollsheet_summary"); ?>">

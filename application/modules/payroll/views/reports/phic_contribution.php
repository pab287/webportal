                    ...
                    <li class="m-portlet__nav-item">
                        <span data-toggle="modal"
                            ...
                            <button class="btn btn-default m-btn m-btn--icon"
                                    data-toggle="m-tooltip" data-original-title="Generate Payroll PHIC Contribution"
                                    data-skin="dark"
                                    data-delay='{"show": 500}'>
                                <span>
        ...
        <div class="m-portlet__body">
            <!--::dt begin::-->
                <div class="m_datatable m-datatable m-datatable--default m-datatable--loaded m-datatable--scroll">
                    <table class="table table-striped table-bordered" id="tbl-phic_remittances" width="100%" style="font-family: roboto;">
                        <thead>
                            <tr>
                                <th>PHIC Number</th>
                                <th>Employee #</th>
...
<div class="modal fade" tabindex="-1" role="dialog" id="generate-report-modal">
    <div class="modal-dialog modal-lg" role="document">
        <div class="modal-content" id="generate-remittance_content">
            ...
            <form id="frm-remittance-report" method="post" action="<?php echo site_url("payroll/reports/generate_phic_remittance_report"); ?>">
...
<div class="modal fade" tabindex="-1" role="dialog" id="modal-ps--signatory">
    <div class="modal-dialog modal-lg" role="document">
        <div class="modal-content" id="signatory--content">
            <div class="modal-header">
                <h5 class="modal-title">PHIC Contribution Signatories</h5>
                <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                    <span aria-hidden="true">&times;</span>
                </button>
            </div>
...
<div class="modal fade" tabindex="-1" role="dialog" id="modal-ps--reset-signatory">
    <div class="modal-dialog" role="document">
        <div class="modal-content" id="reset-signatory--content">
            <div class="modal-header">
                <h5 class="modal-title">Reset - PHIC Contribution Signatories</h5>
                <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                    <span aria-hidden="true">&times;</span>
                </button>
            </div>
                ...
                <table class="table">
                    ...
                    <tbody>
                        <tr v-if="count > 0" v-for="(item, index) in record.rows">
                            ...
                            <td>{{item.ph}}<td>
                            <td>{{formattedAdjustments(item.adjustment, 'phic')}}<td>
                        </tr>
                        <tr v-else>

...
@media print {
    ...
    #ndiff_summary_table, #ndiff_summary_table * { visibility: visible; }
    #ndiff_summary_table {
        position: absolute;
        left: 0;
        top: 0;
            ...
            <div class="m-portlet__head-caption">
                <div class="m-portlet__head-title">
                    <h3 class="m-portlet__head-text">
                        REGULAR NIGHT DIFFERENTIAL SUMMARY <small>Report</small>
                    </h3>
                </div>
            </div>
            ...
            <div id="ndiff_summary_table">
                <div class="tbl-responsive-sm">
                        ...
                        <template v-if="show_header">
                            <div class="row mb-3">
                                <div class="col-md-12 filter-title text-center">
                                    <h5>NIGHT DIFFERENTIAL SUMMARY REPORT</h5>
                    ...
                    <div class="m_datatable m-datatable m-datatable--default m-datatable--loaded m-datatable--scroll">
                        <table class="table table-bordered" style="font-family: roboto; width: 100%;" id="tbl-nightdiff-summary">
                            <thead>
                                <tr>
...
<div class="modal fade" tabindex="-1" id="generate-report-modal">
    <div class="modal-dialog modal-lg">
        <div class="modal-content" id="generate-journal_content">
            ...
            <form id="frm-journal-report" method="post" action="<?php echo site_url("payroll/reports/generate_nightdiff_summary"); ?>">
                ...
                <div  class="modal-body">
                    ...
                    <div class="row">
                        <div id="filter-by-date-range" class="col-xl-6 col-lg-6 col-md-6 col-sm-12" v-if="show_by_date === true">
                            <div class="form-group">
                                <label for="date-range" class="m--font-bolder required">SELECT DATE RANGE</label>

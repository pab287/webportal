<div class="m-content">
            ...
            <div class="m-portlet m-portlet--mobile">
                ...
                <div class="m-portlet__body">
                                ...
                                <div class="form-group m-form__group row align-items-center">
                                    <div class="col-md-12">
                                        <a href="javascript:void(0);"
                                           class="btn btn-success m-btn m-btn--custom m-btn--icon m-btn--air m-btn--pill btnNew btnNewSequence"
                                           data-toggle="modal"
                                           data-target="#modal-add_sequence_items">
											<span>
												<i class="la la-plus"></i>
												<span> New</span>
											</span>
                                        </a>
                                        <a id="sequence_item-list" href="javascript:void(0);"
                                           class="btn btn-info m-btn m-btn--custom m-btn--icon m-btn--air m-btn--pill btnAssign btnAssignSequenceItems">
                                            <span>
                    ...
                    <div class="m_datatable m-datatable m-datatable--default m-datatable--loaded m-datatable--scroll table-responsive-sm">
                        <table class="table table-striped table-bordered" id="table-sequence_items" width="100%">
                            <thead>
                            <tr>
                                <th>Name</th>
                                <th>Label</th>
    ...
    <div class="modal fade" tabindex="-1" role="dialog" id="modal-add_sequence_items">
        <div class="modal-dialog" role="document">
            <form action="<?php echo site_url("pms/task/set_modal_sequence_item"); ?>" id="frmAddSequenceItem">
                <input type="hidden" name="csrf_token" value="<?php echo $this->security->get_csrf_hash(); ?>">
                <div class="modal-content">
                    <div class="modal-header">
                        <h5 class="modal-title">Add Sequence Item</h5>
                    ...
                    <div class="modal-body">
                        <div class="form-group">
                            ...
                            <input id="name" name="name" class="form-control m-input m--uniqueCode"
                                   data-validation="required" autocomplete="off"/>
                        </div>
                        <div class="form-group">
                            <label for="label">Label *</label>
                            <input id="label" name="label" class="form-control m-input" data-validation="required"
                                   autocomplete="off"/>
                        </div>
                        <div class="form-group">
                            <label for="wo_code">Work Code</label>
                            <input id="wo_code" name="wo_code" class="form-control m-input col-md-3" autocomplete="off"/>
                        </div>
                        <div class="form-group">
                            <label for="">Work Order Type</label>
                            <select id="wo_type_id" name="wo_type_id" class="form-control m-input select2"></select>
                        </div>
                        <div class="form-group">
    ...
    <div class="modal fade" id="modal-sequence_item-list" tabindex="-1" role="dialog" aria-hidden="true">

<div class="modal-dialog" role="document">
    <div class="modal-content">
        ...
        <form id="frmSetTaskQty" method="post" action="<?php echo site_url("pms/task/do_post_event/update_checklist_item_qty"); ?>">
                    ...
                    <div class="row m-row--no-padding align-items-center">
                        <div class="col">
                            <div class="form-group m-form__group row m--marginless">
                                ...
                                <div class="col-8">
                                    <input id="tempQty" class="form-control m-input" type="text" name="qty" autocomplete="off" data-validation="valid_quantity" value="<?php echo ($qty)? $qty: 0; ?>" />
                                </div>
                            </div>
                        </div>
                    </div>

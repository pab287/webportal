<div class="modal-dialog" role="document">
    <div class="modal-content">
        <form action="<?= base_url("pms/rates/add_unit") ?>" id="frm-add-unit">
            ...
            onSuccess: function (el) {
                ...
                $.ajax({
                    ...
                    success: function (response) {
                        if (response) {
                            toastr.success("Unit was successfully saved.", "Unit Added.", 10000);
                            ...
                            toastr.error("An error occurred.", "Error Adding Unit", 10000);
                        }
                    },
                    error: function (xhr, status, error) {
                        const err = eval("(" + xhr.responseText + ")");
                        toastr.warning(err, "Error Adding Unit", 10000);
                    }
                });
                return false;
            }

<div class="m-content">
                ...
                <div class="m-portlet__body">
                        ...
                        <div class="row align-items-center">
                            <div class="col-xl-8 order-2 order-xl-1">
                                <div class="form-group m-form__group row align-items-center">
                                    <div class="col-md-12">
                                        <button class="btn btn-success m-btn m-btn--custom m-btn--icon m-btn--air m-btn--pill btnNew"
                                        ...
                                        <button id="sequence_item-list" onclick="openTreeView()"
                                                class="btn btn-info m-btn m-btn--custom m-btn--icon m-btn--air m-btn--pill btnAssign">
                                            <span><i class="fa fa-list"></i><span>Tree View</span></span>
                                        </button>
                                    </div>
                                </div>
                            </div>
                    ...
                    <div class="m_datatable m-datatable m-datatable--default
                        ...
                        <table class="table table-striped table-bordered"
                               id="table-rate-category" width="100%">
                            <thead>
                            <tr>
                                <th>CATEGORY</th>
    ...
    <div class="modal fade" id="modal-archive-confirmation" tabindex="-1" role="dialog">
        <div class="modal-dialog" role="document">
            <form action="" id="frm-archive-category">

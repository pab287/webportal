<div class="m-content">
            ...
            <div class="m-portlet m-portlet--mobile">
                ...
                <div class="m-portlet__body">
                    ...
                    <div class="m_datatable m-datatable m-datatable--default m-datatable--loaded m-datatable--scroll table-responsive-sm">
                        <table class="table table-striped table-bordered" id="table-wo_type" width="100%">
                            <thead>
                            <tr>
                                <th>Code</th>
                                <th>Label</th>
    ...
    <div class="modal fade" tabindex="-1" role="dialog" id="modal-add_wo_type">
        <div class="modal-dialog" role="document">
            <form action="<?php echo site_url("pms/work_order/set_modal_wo_type"); ?>" id="frmAddWoType">
                <input type="hidden" name="csrf_token" value="<?php echo $this->security->get_csrf_hash(); ?>">
                <div class="modal-content">
                    <div class="modal-header">
                        <h5 class="modal-title">Add Work Order Type</h5>

<div class="m-content">
            ...
            <div class="m-portlet m-portlet--mobile">
                ...
                <div class="m-portlet__body">
                                ...
                                <div class="form-group m-form__group row align-items-center">
                                    <div class="col-md-12">
                                        <a href="javascript:void(0);"
                                           class="btn btn-success m-btn m-btn--custom m-btn--icon m-btn--air m-btn--pill btnNew btnNewProjectLocation"
                                           data-toggle="modal"
                                           data-target="#modal-add_project_location">
											<span>
                    ...
                    <div class="m_datatable m-datatable m-datatable--default m-datatable--loaded m-datatable--scroll table-responsive-sm">
                        <table class="table table-striped table-bordered" id="table-project_location" width="100%">
                            <thead>
                            <tr>
                                <th>Code</th>
                                <th>Description</th>
    ...
    <div class="modal fade" tabindex="-1" role="dialog" id="modal-add_project_location">
        <div class="modal-dialog" role="document">
            <form action="<?php echo site_url("pms/project/set_modal_project_location"); ?>" id="frmAddProjectLocation">

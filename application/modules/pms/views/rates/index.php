<div class="m-content">
            ...
            <div class="m-portlet m-portlet--mobile">
                ...
                <div class="m-portlet__body">
                    ...
                    <div class="m_datatable m-datatable m-datatable--default m-datatable--loaded m-datatable--scroll table-responsive-sm">
                        <table class="table table-striped table-bordered" id="table-item_rates" width="100%">
                            <thead>
                            <tr>
                                <th>Parent</th>
                                <th>Item</th>
    ...
    <div class="modal fade" tabindex="-1" role="dialog" id="modal-add_item_rate">
        <div class="modal-dialog" role="document">
            <form action="<?php echo site_url("pms/rates/do_post_event/set_modal_item_rate"); ?>" id="frmAddItemRate">
                <input type="hidden" name="csrf_token" value="<?php echo $this->security->get_csrf_hash(); ?>">
                <div class="modal-content">
                    <div class="modal-header">
                        <h5 class="modal-title">Add Item Rate</h5>
                    ...
                    <div class="modal-body">
                        <div class="form-group">
                            ...
                            <select id="item_id" name="item_id" class="form-control m-input select2"
                                    data-validation="required"></select>
                        </div>
                        <div id="tempFields"></div>
                        <div class="form-group">
                            <label for="unit">Unit *</label>
                            <select id="unit" name="unit" class="form-control m-input select2"
                                    data-validation="required"></select>
                        </div>
                        <div class="form-group">

<input type="hidden" name="item_id" value="<?php echo (isset($item_id) && $item_id)? $item_id: 0; ?>" />
<input type="hidden" name="block_no" value="<?php echo (isset($row->block) && $row->block)? $row->block: 0; ?>" />

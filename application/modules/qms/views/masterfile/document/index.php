...
<div class="m-content">
                    ...
                    <div class="m-portlet__head-tools">
                        <ul class="m-portlet__nav">
                            <li class="m-portlet__nav-item m-dropdown m-dropdown--inline m-dropdown--arrow m-dropdown--align-right m-dropdown--align-push"
                                ...
                                <a href="<?=base_url('qms/masterfile/archived_document') ?>" class="m-portlet__nav-link m-portlet__nav-link--icon m-portlet__nav-link--icon-xl btnView">
                                    Archives
                                </a>
                            </li>
                        </ul>
                            ...
                            <div class="row border">
                                <div class="col-md-2 p-0">
                                    <div class="nav flex-column nav-pills m-0 d-flex flex-nowrap flex-column" id="v-pills-tab" role="tablist" aria-orientation="vertical">
                                        <template v-for="(item, index) in row">
                                            <a class="nav-link" :class="index == 0 ? 'active' : ''" :id="'v-pills-'+item.grouped+'-tab'" data-toggle="pill" :href="'#v-pills-'+item.grouped" role="tab" aria-selected="true" @click="item.grouped == 'memorandum' || item.grouped == 'kra_kpi' ? getTimeline(item.id, item.grouped) : getContent(item.grouped, item.id)">{{ item.name }}</a>
                                        </template>
                                    </div>
                                </div>
                                <div class="col-md-10 p-4">
                                    <div class="tab-content" id="v-pills-tabContent">
                                        <template v-for="(item, index) in row">
                                            <div class="tab-pane" :class="index == 0 ? 'show active' : 'fade'" :id="'v-pills-'+item.grouped" role="tabpanel">
                                                <template v-if="index == 0 && item.grouped == 'memorandum' || item.grouped == 'kra_kpi'">
                                                    <div class="row justify-content-between mb-2">
                                                        <div class="col-md-6">
                                                            <div class="row">
                                                                <div class="col-md-2 mr-2">
                                                                    <div class="form-group m-form__group row align-items-center">
                                                                        <div class="col-md-12">
                                                                            ...
                                                                            <div class="dropdown-menu" aria-labelledby="dropdownMenuButton" x-placement="bottom-start" style="position: absolute; transform: translate3d(0px, 37px, 0px); top: 0px; left: 0px; will-change: transform;">
                                                                                <a class="dropdown-item" href="#" data-toggle="modal" data-target="#modal-timeline-query-builder">
                                                                                    Query Builder
                                                                                </a>
                                                                                <a id="timeline-advance-search" class="dropdown-item" href="#" data-toggle="modal" data-target="#modal-advance-search">
                                                                                    Advance Search
                                                                                </a>
                                                                            </div>
                                                                        </div>
                                                                ...
                                                                <div class="col-md-3">
                                                                    <select :id="item.grouped+'-anchorToYear'" class="form-control form-control-solid"></select>
                                                                </div>
                                                            </div>
                                                        </div>
                                                        <div class="col-md-3">
                                                            <div class="m-input-icon m-input-icon--left" style="border: 1px solid #c3c3c3;">
                                                                <input type="text" class="form-control m-input m-input--solid" placeholder="Search..." @input="getSearchMemo($event)" :id="item.grouped+'-generalSearch'">
                                                                <span class="m-input-icon__icon m-input-icon__icon--left">
                                                                    <span> <i class="la la-search"></i> </span>
                                                                </span>
                                                            </div>
                                                    ...
                                                    <div class="custom-scrollbar scrollable" style="height: 490px;">
                                                        <div class="row">
                                                            <div class="col-md-12">
                                                                <template v-if="timelineCount > 0">
                                                                    <template v-for="(item, index) in timeline">
                                                                        <div class="row">
                                                                            <div :id="item.ref_year" class="col1">
                                                                                <span>{{ item.ref_year }}</span>
                                                                            </div>
                                                                        </div>
                                                                        <ul class="timeline">
                                                                            <template v-for="(v, i) in item.contents">
                                                                                <li>
                                                                                    <div class="row">
                                                                                        <div class="col-md-10">
                                                                                            <p>
                                                                                                <b style="font-weight: 800">Document No:</b> 
                                                                                                <a href="javascript:void(0)" style="text-decoration: none" @click="viewPDF(v.filename, v.id, v.title, v.file_exist)">{{ v.document_no }}</a>
                                                                                            </p>
                                                                                        </div>
                                                                                        <div class="col-md-2">
                                                                                            <ul class="m-portlet__nav p-0 text-right">
                                                                                                                ...
                                                                                                                <div class="m-dropdown__content">
                                                                                                                    <ul class="m-nav">
                                                                                                                        ...
                                                                                                                        <li class="m-nav__item">
                                                                                                                            <a href="javascript:void(0)" data-toggle="modal" class="m-nav__link btnViewPolicy" @click="viewPDF(v.filename, v.id, v.title, v.file_exist)">
                                                                                                                                View Document
                                                                                                                            </a>
                                                                                                                        </li>
                                                                                                                        <li class="m-nav__item">
                                                                                                                            <a href="javascript:void(0)" class="m-nav__link btnBlacklist btnEditPolicy" :data-id="v.id">
                                                                                                                                Edit Document
                                                                                                                            </a>
                                                                                                                        </li>
                                                                                                                        <li class="m-nav__item">
                                                                                                                            <a href="javascript:void(0)" class="m-nav__link btnBlacklist" @click="removeCurrentPolicy(v)">
                                                                                                                                Archive Document
                                                                                                                            </a>
                                                                                                                        </li>
                                                                                                                    </ul>
                                                                                    ...
                                                                                    <div class="row">
                                                                                        <div class="col-md-10">
                                                                                            <p class="m-0"><b style="font-weight: 800">Title:</b> {{ v.title }}</p>
                                                                                        </div>
                                                                                    </div>
                                                                                    <div class="row">
                                                                                        <div class="col-md-9">
                                                                                            <p class="m-0"><b style="font-weight: 800">Objectives</b></p>
                                                                                            <p>{{ v.objective }}</p>
                                                                                            <p class="mb-0"><b style="font-weight: 800">Author:</b> {{ v.author }}</p>
                                                                                        </div>
                                                                                        <div class="col-md-3">
                                                                                            <p><b style="font-weight: 800">Companies under this document</b></p>
                                                                                            <p>{{ getList(v.companies) }}</p>
                                                                                        </div>
                                                                                    </div>
                                                                                    <hr>
                                                                                </li>
                                                ...
                                                <template v-else>
                                                    <div class="row align-items-center">
                                                        ...
                                                        <div class="col-xl-4 order-1 order-xl-2 m--align-right">
                                                            <div class="m-input-icon m-input-icon--left" style="border: 1px solid #c3c3c3;">
                                                                <input type="text" class="form-control m-input m-input--solid" placeholder="Search..." @input="getSearchEvent($event)" :id="item.grouped+'-generalSearch'">
                                                                <span class="m-input-icon__icon m-input-icon__icon--left">
                                                                    <span> <i class="la la-search"></i> </span>
                                                                </span>
                                                            </div>
                                                    ...
                                                    <table :id="'table-'+item.grouped" class="table table-striped table-bordered" width="100%"></table>
                                                </template>
                                            </div>
                                        </template>
                                    </div>
    ...
    <div class="modal fade" id="modalTempContent" role="dialog">
    ...
    <div class="modal fade" tabindex="-1" role="dialog" id="modal-timeline-query-builder">
        <form id="frm-query-builder">
            <div class="modal-dialog modal-lg" role="document">
                <div class="modal-content">
                    <div class="modal-header">
                    ...
                    <div class="modal-body">
                        <div id="timeline-query-builder"></div>
                    </div>
                    <div class="modal-footer">
                        <button type="button" onclick="clear_timeline_query_builder()" class="btn btn-danger btnAdvance_search mr-auto">Clear</button>
                        <button type="button" id="timeline-query-builder-btn" class="btn btn-primary btnAdvance_search">Generate</button>
                    </div>
                </div>
            </div>
        </form>
    ...
    <div class="modal fade" id="modalAdvanceSearch" tabindex="-1" role="dialog" id="modal-advance-search">
        <div class="modal-dialog modal-md" role="document">
            <form method="POST" id="advance-search-form">
                <div id="modalTempContainer" class="modal-content">
                    <div class="modal-header">
                    ...
                    <div id="modalSearchForm">
                        <div class="modal-body">
                            ...
                            <div class="row">
                                <div class="col-md-12">
                                    <div class="form-group">
                                        <label for="">Departments under document</label>
                                        <select id="department" class="form-control form-control-solid" multiple>
                                        </select>
                                    </div>
                                </div>
                            </div>
                    ...
                    <div class="modal-footer">
                        <button type="button" onclick="clear_advance_search()" class="btn btn-danger btnAdvance_search mr-auto">Clear</button>

                    ...
                    <div class="m-portlet__head-caption">
                        <div class="m-portlet__head-title">
                            <h3 class="m-portlet__head-text">
                                Document by Company Masterfile
                            </h3>
                        </div>
                    </div>
                                ...
                                <div class="col-md-2 p-0">
                                    <div class="nav flex-column nav-pills m-0 d-flex flex-nowrap flex-column" id="v-pills-tab" role="tablist" aria-orientation="vertical">
                                        <template v-for="(item, index) in row">
                                            <a class="nav-link" :class="index == 0 ? 'active' : ''" :id="'v-pills-'+item.grouped+'-tab'" data-toggle="pill" :href="'#v-pills-'+item.grouped" role="tab" aria-selected="true" @click="getContent(item.grouped, item.company_id)">{{ item.company }}</a>
                                        </template>
                                    </div>
                                </div>

<style>
    #tblnewasset td { word-break: break-word; }
...
<div class="m-content">
                ...
                <form id="frm_status_new">
                    ...
                    <div class="m-portlet__body">
                        ...
                        <div class="row">
                            <div class="col-md-12">
                                <div class="form-group m-form__group row">
                                    <label class="col-lg-2 col-md-2 col-sm-2 col-xs-12 col-form-label">
                                        Contents
                                    </label>
                                    <div id="fix-mobile" class="col-lg-10 col-md-10 col-sm-10 col-xs-12 text-right">
                                        <a class="btn m-btn m-btn--icon btn-warning btnNew text-white" data-toggle='modal' data-target='#add_asset_modal'>
                                                <span>
                                                    <i class="fa fa-plus"></i>
                                                    <span>Asset</span>
                                                </span>
                                        </a>
                                        <a class="btn m-btn m-btn--icon btn-info btnNew text-white" data-toggle='modal' data-target='#add_vehicle_modal'>
                                                <span>
                                                    <i class="fa fa-plus"></i>
                                                    <span>Vehicle</span>
                                                </span>
                                        </a>
                                        <a class="btn m-btn m-btn--icon btn-success btnNew text-white" data-toggle='modal' data-target='#add_multiple_modal'>
                                                <span>
                                                    <i class="fa fa-plus"></i>
                                                    <span>Multiple assets </span>
                                                </span>
                                        </a>
                                        <button type="button" class="btn m-btn m-btn--icon btn-danger btnDelete" data-toggle='modal' data-target='#clear_asset_modal' onclick="clear_temp()">
                                            <span>
                                ...
                                <div class="form-group m-form__group row">
                                    <div class="col-lg-12">
                                        <div class="m_datatable m-datatable m-datatable--default m-datatable--loaded m-datatable--scroll table-responsive-sm">
                                            <table class="table table-striped table-bordered" name="tblcontent" id="tbltemp" width="100%">
                                                <thead>
                                                <tr>
                                                    <th>Asset Code</th>
                                                    <th>Description</th>
                        ...
                        <div class="col-xl-12 order-1 order-xl-2 m--align-right">
                            <button type="submit" class="btn btn-submit m-btn m-btn--custom btn-accent btnSave">
                                <span>
                                    <i class='fa fa-save'></i> 
                                    Save
                                </span>
                            </button>
                            <a href="<?php echo base_url("eforms/accountability/masterfile"); ?>" class="btn m-btn m-btn--custom btn-metal text-white m-btn--air btnClose">Close</a>
                        </div>
                    </div>
            </div>
            </form>
                ...
                <form id="add_asset_form" name="add_item_form">
                    ...
                    <div class="col-12 modal-body">
                        <div class="form-group row">
                            <label class="col-md-3 col-lg-3 col-sm-3 col-xs-12 form-control-label">Asset Code: </label>
    ...
    <!--asset modal-->
    <!--vehicle modal-->
    <div class="modal fade" id="add_vehicle_modal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" style="display: block;">
        <div class="modal-dialog modal-lg" role="document">
            <div class="modal-content">
                <div class="modal-header">
                    ...
                    <div class="col-12 modal-body">
                        <div class="form-group row">
                            ...
                            <div class="col-md-9 col-lg-9 col-sm-9 col-xs-12 input-group">
                                ...
                                <button id='vehicle_search' class='btn m-btn--sm btn-success input-group-addon btnAdvance_search' type='button'>
                                        <span>
                                            <i class="la la-search"></i>
                                        </span>
                                </button>
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-9 col-lg-9 col-sm-9 col-xs-12">
                                <textarea class="form-control" name="asset_name" rows="3" disabled id="vehicle_name"></textarea>
                            </div>
                        </div>
                        <div class="form-group row">
                            <label class="col-md-3 col-lg-3 col-sm-3 col-xs-12 form-control-label">
                        ...
                        <div class="form-group m-form__group row">
                            ...
                            <div class="col-12">
                                <div class="m_datatable m-datatable--scroll col-12">
    ...
    <!--vehicle modal-->
    <!--multipe modal-->
    <div class="modal fade" id="add_multiple_modal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" style="display: block;">
        <div class="modal-dialog modal-lg" role="document">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title" id="exampleModalLabel">Add Multiple Assets</h5>
                    <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                        <span aria-hidden="true">×</span>
                    </button>
                </div>
                    ...
                    <div class="col-12 modal-body">
                        <div class="form-group row">
                            ...
                            <div class="col-md-9 col-lg-9 col-sm-9 col-xs-12 input-group">
                                ...
                                <button id='multiple_search' class='btn m-btn--sm btn-success input-group-addon btnAdvance_search' type='button'>
                                        <span>
                                            <i class="la la-search"></i>
                                        </span>
                                </button>
                        ...
                        <div class="form-group m-form__group row">
                            ...
                            <div class="col-12">
                                <div class="m_datatable m-datatable--scroll col-12 table-responsive-sm">
                                    <table class="table table-striped table-bordered" name="tbladdedlist" id="tbladdedlist" width="100%">
                                        <thead>
                                        <tr>
                                            <th>Asset Code</th>
                                            <th>Description</th>
    ...
    <!--multiple modal-->
    <!--edit-asset modal-->
    <div class="modal fade" id="edit_asset_modal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" style="display: block;">
        <div class="modal-dialog modal-lg" role="document">
            <div class="modal-content">
                <div class="modal-header">
                    ...
                    <div class="col-12 modal-body">
                        <div class="form-group row m--hide">
                            ...
                            <div class="col-md-9 col-lg-9 col-sm-9 col-xs-12 input-group">
                                ...
                                <button id='edit_search' class='btn m-btn--sm btn-success input-group-addon btnAdvance_search' type='button'>
                                        <span>
                                            <i class="la la-search"></i>
                                        </span>
                                </button>
                        ...
                        <div class="form-group m-form__group row m--hide">
                            ...
                            <div class="col-12">
                                <div class="m_datatable m-datatable--scroll col-12 table-responsive-sm">
                                    <table class="table table-striped table-bordered" name="tblassetcomp_edit" id="tblassetcomp_edit" width="100%">
                                        <thead>
                                        <tr>
                                            <th>Asset Code</th>
                                            <th>Asset Name</th>
    ...
    <!--delete-asset modal-->
    <div class="modal fade" id="delete_asset_modal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" style="display: block;">

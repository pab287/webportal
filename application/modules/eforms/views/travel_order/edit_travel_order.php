            ...
            <div class="m-portlet m-portlet--mobile">
                    ...
                    <div class="m-portlet__head-caption">
                        <div class="m-portlet__head-title">
                            <span class="m-portlet__head-icon">
                                <a type="button" href="masterfile" title="Back to Viewing" class="btn btn-default m-btn m-btn--icon m-btn--icon-only m-btn--pill btnNew">
                                    <i class="la la-arrow-left"></i>
                                </a>
                            </span>
                            <h3 class="m-portlet__head-text">Edit Travel Order</h3>
                        </div>
                    </div>
                    <div class="m-portlet__head-tools to_status">
                ...
                <div class="m-portlet__body">
                    ...
                    <input type="hidden" name="csrf_token" value="<?php echo $this->security->get_csrf_hash(); ?>">
                                ...
                                <div class="form-group m-form__group row">
                                    ...
                                    <div class="col-md-10 col-lg-10 col-sm-10 col-xs-12">
                                        <div class="m-radio-inline" id="radio_type">
                                            <label class="m-radio" data-container="body" data-toggle="m-tooltip" data-placement="top" data-original-title="Within the company" data-skin='dark'>
                                                <input type="radio" id="internal" name="type" value="internal">
                                                Internal
                                                <span></span>
                                            </label>
                                            <label class="m-radio" data-container="body" data-toggle="m-tooltip" data-placement="top" title="" data-original-title="Not within the company" data-skin='dark'>
                            ...
                            <div class="col-md-6 col-sm-12">
                                <div class="form-group m-form__group row">
                                    ...
                                    <div class="col-md-9 col-lg-9 col-sm-9 col-xs-12">
                                        <textarea name="station" rows="3" cols="50"  class="form-control" data-validation="required">{{vm_tab1.station}}</textarea> 
                                    </div>
                                </div>
                                <!-- <div class="form-group m-form__group row">
                                    <label class="col-md-3 col-lg-3 col-xs-12 col-form-label">
                                    Origin
                                    </label>
                                    <div class="col-md-9 col-lg-9 col-sm-9 col-xs-12">
                                        <textarea name="origin" rows="3" cols="50" class="form-control" data-validation="required">{{vm_tab1.origin}}</textarea> 
                                    </div>
                                </div> -->
                                <div class="form-group m-form__group row">
                                ...
                                <div class="form-group m-form__group row" id="service_veh">
                                    ...
                                    <div class="col-md-9 col-lg-9 col-sm-9 col-xs-12">
                                        <select id="select2_vehicle" name="vehicle" data-validation="required" >
                        ...
                        <template v-if="vm_tab1.last_edited_by">
                            <div class="m-separator m-separator--dashed d-xl-12"></div>
                            <div class="row" id="layout_content" style="pointer-events: none;">
                                <div class="col-md-6 col-sm-12">
                                    <div class="form-group m-form__group row">
                                        <label class="col-md-3 col-lg-3 col-xs-12 m--font-bolder">
                                            Last Edited By:
                                        </label> 
                                    <div id="edited" class="col-md-9 col-lg-9 col-sm-9 col-xs-12">
                                        <b>{{vm_tab1.last_edited_by}} {{moment(vm_tab1.last_edited_dt).format('LLL')}}</b>
                                    </div>
                                </div>
                            </div>
                        </template>
                        <div class="m-separator m-separator--dashed d-xl-12"></div> 
                        <div class="row" id="layout_bottom_content" style="pointer-events: none;">
                            <div class="col-md-6 col-sm-12">
                                <div class="form-group m-form__group row">
                                    <div class="col-12 text-right m--margin-bottom-10 m--hide" id="layout_btn_personnel">
                                        <a  class="btn btn-primary  btnNew text-white m-btn--sm" onclick="add_personnel()"> 
                                            <span>
                                                <i class="la la-users"></i>            
                                            <span>                                                         
                                            Add Personnel
                                        </a>   
                                        <button type="button"  class="btn btn-danger m-btn--sm btnNew " onclick="clear_personnel()">
                                    ...
                                    <div class="col-md-4 col-sm-12 m--hide" id="table_v">
                            ...
                            <div class="col-md-6 col-sm-12">
                                <div class="form-group m-form__group row">
                                    <div class="col-12 text-right m--margin-bottom-10 m--hide" id="layout_btn_destination">
                                        <a  class="btn btn-primary  btnNew text-white m-btn--sm" onclick="add_destination()"> 
                                            <span>
                                        ...
                                        <button type="button"  class="btn btn-danger m-btn--sm btnNew " onclick="clear_destination()">
                                            <i class="la la-trash"></i>
                                            Clear
                                        </button>
                                    </div>            
                                    ...
                                    <div class="col-md-4 col-sm-12 m--hide" id="table2_v">
                                        <p style="color: #ff0000; font-size: 10px; font-weight: bold;">Required. Add atleast 1 Content</p>
                                    </div>
                                </div>
                            </div>
                        ...
                        <div id="fix-mobile" class="modal-footer">
                            <button type="submit" id="btnRecommendTravel" onclick="update_travel_order(true)" class="btn btn-info btnSave m--hide">Submit And Recommend</button>
                            <button type="submit" id="btnSaveTravel" onclick="update_travel_order()" class="btn btn-accent btnSave m--hide"><i class="la la-floppy-o"></i> Submit</button>
                    ...
                    <form action="#" id="form_destination" class="form-horizontal">
                        ...
                        <div class="modal-body form">
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-md-12">
                                    <textarea name="remarks" class="form-control" data-validation="required custom_remarks" data-validation-error-msg="Remarks must be at least 30 characters"></textarea> 
                                </div>
                            </div>
                        </div>
                        <div class="modal-footer">
...
<div class="modal fade" id="modal_recommend_approve" role="dialog">
    <div class="modal-dialog">
        <div class="modal-content">
            <div class="modal-header">
                <h3 class="modal-title">Recommendation</h3>
                <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                    <span aria-hidden="true">&times;</span>
                </button>
            </div>
            <form id="formRecommend">
                <input type="hidden" name="csrf_token" value="<?php echo $this->security->get_csrf_hash(); ?>">
                <div class="modal-body form">
                ...
                <div class="modal-footer">    
                    <button type="submit" class="btn btn-primary m-btn m-btn--custom m-btn--icon btn-submit btnSave">Save</button>
                    <button type="button" class="btn btn-metal text-white m-btn m-btn--custom m-btn--icon btnCancel" data-dismiss="modal">Cancel</button>
                </div>
            </form>
        </div>

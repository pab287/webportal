                ...
                <input type="hidden" name="csrf_token" value="<?php echo $this->security->get_csrf_hash(); ?>">
                    <div class="m-portlet__body">
                            ...
                            <div class="col-md-6">
                                <div class="form-group m-form__group row">
                                    ...
                                    <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12 col-xl-10">
                                        <select id="type" name="cat"  data-validation="required">
                            ...
                            <div class="col-md-6">
                                <div class="form-group m-form__group row">
                                    ...
                                    <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12 col-xl-9">
                                        <select id="select_file_under" name="company_from"  data-validation="required">
                                ...
                                <div class="form-group m-form__group row">
                                    ...
                                    <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12 col-xl-9">
                                        <select id="select_requested_by" name="requested_by"  data-validation="required">
                            ...
                            <div class="col-md-12">  
                                <div class="form-group m-form__group row">
                                    ...
                                    <div id="fix-mobile" class="col-xs-12 col-sm-12 col-md-10 col-lg-10 col-xl-10 text-right">
                                        <a class="btn btn-primary m-btn--sm btnNew mt-1 text-white" data-toggle='modal' data-target='#add_item_modal'> 
                                            <span>
                                        ...
                                        <a class="btn btn-primary m-btn--sm btnNew mt-1 text-white" data-toggle='modal' data-target='#add_asset_modal' > 
                                            <span>
                                                <i class="la la-plus"></i>            
                                                <span>                             
                                                    Add Asset    
                                        ...
                                        <button type="button" class="btn m-btn--sm mt-1 btn-danger btnNew" id="clear">
                        ...
                        <div class="row">
                            <div class="col-md-6" id="ex">  
                                ...
                                <div class="form-group m-form__group row">
                                    ...
                                    <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12 col-xl-9">
                                        <textarea name="ship_to_address" id="address" class="form-control" rows="4" data-validation="required"></textarea>
                                    </div>
                                </div>
                                <div class="form-group m-form__group row">
                                    <label class="col-xs-12 col-sm-12 col-md-12 col-lg-12 col-xl-3 col-form-label">
                                    ...
                                    <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12 col-xl-9 input-group date" id="due_dt">
                                        <input class="form-control m-input" type="text" name="ship_date" id="date" maxlength="22" data-validation="required"/>
                            ...
                            <div class="col-md-6">
                                ...
                                <div class="form-group m-form__group row">
                                    ...
                                    <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12 col-xl-9">
                                        <input class="form-control m-input" type="transporter" name="transporter" id="transporter" data-validation="required"/>
                                    </div>
                                </div>
                        ...
                        <div class="col-xl-12 order-1 order-xl-2 m--align-right">
                            <button type="submit" class="btn btn-info m-btn m-btn--custom m-btn--icon m-btn--air m-btn--box">
                                <span>
...
<div class="modal fade" id="add_item_modal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" style="display: block;">
    <div class="modal-dialog modal-md" role="document">
        <div class="modal-content">
            ...
            <div id="add_item_content" hidden>
...
<!--item modal edit-->
<div class="modal fade" id="edit_item_modal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel">
    <div class="modal-dialog modal-md" role="document">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title" id="exampleModalLabel">
                ...
                <form id="edit_item_form" name="edit_item_form">
                    <div class="col-12 modal-body">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-5">
                                <input type="text" name="quantity" id="quantity" class="form-control" id="quantity" />
                            </div>
                            <div class="col-5">
                                <input type="text" name="uom" class="form-control" id="uom" />
                                <span style="color: red;"><small>UOM <i>(Unit of Measurement)</i></small></span>

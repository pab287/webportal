                    ...
                    <tbody>
						...
						<tr>
							<td align="left" style="color: #888888; font-size: 16px; font-family: 'Work Sans', Calibri, sans-serif; line-height: 24px;">
								<div style="line-height: 24px">You have <strong>Borrowed Item(s)</strong> due <strong style="color: #ff0000;">TODAY <?php echo (isset($date) && $date)? date("F d, Y", strtotime($date)): date("F d, Y"); ?></strong>.</div>
							</td>
						</tr>
						<tr>
						...
						<tr>
							<td align="left" style="color: #888888; font-size: 16px; font-family: 'Work Sans', Calibri, sans-serif; line-height: 24px;">
								<div style="line-height: 24px">
                                    Kindly return the items to the warehouse or ask assistance for extension of borrowed items. Thank you.
                                </div>
							</td>
						</tr>
						<tr>

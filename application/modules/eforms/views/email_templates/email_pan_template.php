                            ...
                            <table border="0" align="center" width="980" cellpadding="0" cellspacing="0" class="container980">
								<tr>
                                    <td align="center" height="70" style="height:70px;">
										...
										<h2 style="font-family: Quicksand, Calibri, sans-serif; margin-top: 15px; color:#343434; text-transform: uppercase;">Accountability <?php if($is_urgent){echo " - [ URGENT ]"; } ?></h2>
				...
				<table border="0" align="center" width="980" cellpadding="0" cellspacing="0" class="container980">
					...
					<tr>
						<td align="left" style="color: #888888; font-size: 16px; font-family: 'Work Sans', Calibri, sans-serif; line-height: 24px;">
                            <?php if($type=="add"){ $type = "Accounting Note"; }elseif($type == "hr_note"){ $type = "HR Note"; }?>
							<div style="line-height: 24px">A new Accountability entry for <strong style="font-size: 18px; color: #ff0000; text-transform: uppercase;"><?php echo (isset($employee_name) && $employee_name)? $employee_name: "Employee Name"; ?></strong> has been processed. Kindly update your record and log in to WEBPORTAL and click the "<?php echo $type; ?>" on the Accountability E-forms so it can be released to the employee promptly.</div>
						</td>
					</tr>
					<tr>
					...
					<tr>
						<td align="left" style="color: #888888; font-size: 16px; font-family: 'Work Sans', Calibri, sans-serif; line-height: 24px; font-weight: 500;">
							<div style="line-height: 24px">Thank you!</div>
						</td>
					</tr>
					<tr>

                            ...
                            <table border="0" align="center" width="980" cellpadding="0" cellspacing="0" class="container980">
								<tr>
                                    <td align="center" height="70" style="color: #343434; font-family: Quicksand, Calibri, sans-serif; font-weight:700;letter-spacing: 0px; text-align: center;">
										...
										<h4 align="center" style="margin-top: 15px;">BORROWING FORM - DUE ITEMS</h4>
                    ...
                    <tbody>
						...
						<tr>
							<td align="left" style="color: #888888; font-size: 16px; font-family: 'Work Sans', Calibri, sans-serif; line-height: 24px;">
								<div style="line-height: 24px">The following <strong>Borrowed Item(s)</strong> are due <strong style="color: #ff0000;">TODAY <?php echo (isset($date) && $date)? date("F d, Y", strtotime($date)): date("F d, Y"); ?></strong>.</div>
							</td>
						</tr>
						<tr>
                ...
                <table align="center" border="0" width="980" cellpadding="0" cellspacing="0" bgcolor="ffffff">
                    ...
                    <thead>
                        <tr class="cleared-items">
                            <td colspan="5">
                                <h4 style="background-color: #efefef; padding: 10px 5px; font-weight: bold; font-family: Quicksand, Calibri, sans-serif; text-align: center; margin-bottom: 10px;">DUE ITEMS</h4>
                            </td>
                        </tr>
                        <tr>
                            ...
                            <th align="left" style="color: #343434; font-size: 14px; font-family: Quicksand, Calibri, sans-serif; font-weight:700;letter-spacing: 0px; line-height: 35px; margin-bottom: 10px;">EMPLOYEE</th>
                   ...
                   <tbody>
                        ...
                        <tr>
                            ...
                            <td align="left" width="450" v-align="top" style="vertical-align: text-top; color: #343434; font-size: 14px; font-family: 
                                'Work Sans', Calibri, sans-serif; line-height: 18px; font-weight: 500;">
                                <?php echo (isset($value->name) && trim($value->name))? trim($value->name): "---"; ?>
                            </td>
                            <td align="right" width="160" v-align="top" style="vertical-align: text-top; color: red; font-size: 14px; font-family: 
                                'Work Sans', Calibri, sans-serif; line-height: 18px; font-weight: 1000;">

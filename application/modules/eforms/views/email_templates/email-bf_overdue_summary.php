                    ...
                    <tbody>
						...
						<tr>
							<td align="left" style="color: #888888; font-size: 16px; font-family: 'Work Sans', Calibri, sans-serif; line-height: 24px;">
								<div style="line-height: 24px">The following <strong>Borrowed Item(s)</strong> are overdue <strong style="color: #ff0000;">as of <?php echo (isset($date) && $date)? date("F d, Y", strtotime($date)): date("F d, Y"); ?></strong>.</div>
							</td>
						</tr>
						<tr>

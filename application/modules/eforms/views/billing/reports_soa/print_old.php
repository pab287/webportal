...
<head>
    ...
    <style type="text/css">
        ...
        @media print {
            @page {
                size: A4; /* Sets the suggested paper size to A4 */
                margin: 0 1cm; /* Optional: Sets default page margins */
            }
                ...
                <tr class="head">
                    <td align="center">
                        ...
                        <?php if(isset($data['report_type']) && $data['report_type'] == "payment") { ?>
                            ...
                            <table border="0" width="890" cellpadding="0" cellspacing="0" class="container980" align="center">
                                ...
                                <tr style="background-color: #bad3f1">
                                    ...
                                    <th align="right" style="font-family: arial; color:#343434; padding: 6px;">Bill</th>
                                    <th align="right" style="font-family: arial; color:#343434; padding: 6px;">Penalty</th>
                                    <th align="right" style="font-family: arial; color:#343434; padding: 6px;">Covered</th>
                                    <th align="right" style="font-family: arial; color:#343434; padding: 6px;">Net</th>
                                    <th align="right" style="font-family: arial; color:#343434; padding: 6px;">Received</th>
                                </tr>
                            </table>
                        ...
                        <?php } elseif(isset($data['report_type']) && $data['report_type'] == "billing") { ?>
                            ...
                            <table border="0" width="890" cellpadding="0" cellspacing="0" class="container980" align="center">
                                <tr style="background-color: #bad3f1">
                                    <th align="center" style="font-family: arial; color:#343434; padding: 6px;" width="180">REFERENCE NO.</th>
                                    <th align="center" style="font-family: arial; color:#343434; padding: 6px;" width="180">BILLING FROM</th>
                                    <th align="center" style="font-family: arial; color:#343434; padding: 6px;" width="180">BILLING TO</th>
                                    <th align="center" style="font-family: arial; color:#343434; padding: 6px;" width="180">USAGE</th>
                                    <th align="right" style="font-family: arial; color:#343434; padding: 6px;" width="180">TOTAL CHARGES</th>
                                </tr>
                            </table>
                        ...
                        <?php } else { ?>
                            ...
                            <table border="0" width="890" cellpadding="0" cellspacing="0" class="container980" align="center">
                                <tr style="background-color: #bad3f1">
                                    <th align="center" style="font-family: arial; color:#343434; padding: 6px;" width="296">DUE DATE</th>
                                    <th align="center" style="font-family: arial; color:#343434; padding: 6px;" width="296">REFERENCE NO.</th>
                                    <th align="right" style="font-family: arial; color:#343434; padding: 6px;" width="296">DEBIT</th>
                                    <th align="right" style="font-family: arial; color:#343434; padding: 6px;" width="296">CREDIT</th>
                                    <th align="right" style="font-family: arial; color:#343434; padding: 6px;" width="296">BALANCE</th>
                                </tr>
                            </table>
                    ...
                    <table border="0" align="center" width="890" cellpadding="0" cellspacing="0" class="container980">
                        ...
                        ?>
                                ...
                                <tr style="background-color: <?= $bgcolor ?>">
                                    ...
                                    <td align="center" style="font-family: arial; color:#343434; padding: 6px;" width="180">
                                        <?= date('M d, Y', strtotime($_query["billing_from"])); ?>
                                    </td>

                                    <td align="center" style="font-family: arial; color:#343434; padding: 6px;" width="180">
                                        <?= date('M d, Y', strtotime($_query["billing_to"])); ?>
                                    </td>
                    ...
                    <table border="0" align="center" width="890" cellpadding="0" cellspacing="0" class="container980">
                        ...
                        ?>
                                    <tr style="background-color: <?= $bgcolor ?>">
                                        ...
                                        <td align="center" style="font-family: arial; color:#343434; padding: 6px;" width="180">
                                            <?= date("M d, Y", strtotime($_query["reading_date"])); ?>
                                        </td>
                                        <td align="center" style="font-family: arial; color:#343434; padding: 6px;" width="180">
                        ...
                        <tr class="footer" style="background-color: #bad3f1;">
                            <td align="center" style="font-family: arial; color:#343434; padding: 6px;" width="180"></td>
                            <td align="center" style="font-family: arial; color:#343434; padding: 6px;" width="180"><strong>TOTAL</strong></td>
                            <td align="center" style="font-family: arial; color:#343434; font-weight: bold; padding: 6px;" width="180">
...
<p style="max-width: 10%;">DUE DATE</p>
<p style="max-width: 15%;">REF #</p>

...
<div style="max-width: 500px;padding: 10px;border: 1px solid #000;" >
                                                ...
                                                <td>
                                                    <table width="100%" cellpadding="4" cellspacing="0">
                                                        ...
                                                        <tr>
                                                            ...
                                                            <td colspan="1" style="padding-right: 0px;position:relative; width: 200px;"><div style="border: 1px solid; padding: 10px; height:50%;position:absolute;display:flex;align-items:center; width: 90%;"><strong style="border: 2px solid #000;padding: 2px;"><?php if($data["usage"] >= 11.46){echo "&nbsp;&nbsp;";}else{echo "x";}?></strong> <span style="text-align: center;">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Minimum Usage &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;(11.46 cu.m)</span></div></td>
                                                        </tr>
                                                        </tbody>
                                                    </table>
                                                </td>
    ...
    <table cellpadding="2" id="form-input_content" style="margin: 0 auto;max-width: 300px;">
        ...
        <tbody id="charges">
            ...
            <tr>
                ...
                <td colspan="1" style="border-bottom: 1px solid;padding-left: 5px; width: 100px; text-align: right;"><?php echo number_format($data["total_charges"],2,".",",");?></td>
            </tr>
            <tr>
                <td colspan="3" style="width: 300px;"><strong>Reconnection fee:</strong></td>
                <td colspan="1" style="border-bottom: 1px solid;padding-left: 5px; width: 100px; text-align: right;">0.00</td>
            </tr>
            <tr>
    ...
    <table cellpadding="2" style="margin: 0 auto;max-width: 200px;padding-top: 10px;">
        <tbody id="dues"  style="padding-bottom: 10px;">
            ...
            <tr>
                ...
                <td style="border-bottom:1px solid;padding-left: 5px;"><div style="width: 100%; text-align: right;">0.00</div></td>
                <td width="12%"></td>
            </tr>
            <tr>
                <td width="12%"></td>
    ...
    <table width="500">
        <tbody style="padding-bottom: 10px;">
            <tr>
                <td colspan="4" style="padding: 5px 10px;border: 2px solid;"><div style="width: 80%;float: left;"><strong>Total Charges: </strong></div> <div style="text-align: center;width: 20%;float:right;text-align: right;"><strong><?php echo number_format($data["total_charges"],2,".",",");?></strong></div><div style="clear:both;"></div></td>
            </tr>
            <tr>
                <td colspan="4" style="padding-top: 10px;">
                    ...
                    <p style="font-style:italic;text-transform:none;margin-bottom: 5px;font-size: 8px;">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Reconnection fee of P150.00 must be paid to resume your service.</p>
                    <p style="font-style:italic;text-transform:none;margin-bottom: 5px;font-size: 8px;">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;For check payment, please make your checks payable to <strong><u>BACOLOD HYDRA INC</u></strong>.</p>

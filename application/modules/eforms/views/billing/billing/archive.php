		...
		<div class="col-lg-12">
			<div class="m-portlet m-portlet--mobile">
              ...
              <span class="m-portlet__head-icon">
                  <a type="button" href="billing" title="Go to Masterfile"
                      class="btn btn-default m-btn m-btn--icon m-btn--icon-only m-btn--pill btnNew">
                      <i class="la la-arrow-left"></i>
                  </a>
              </span>
							<h3 class="m-portlet__head-text">
								BILLING <span><small>(Archive)</small></span>
							</h3>
						</div>
					</div>
          ...
          <div class="m-form m-form--label-align-right m--margin-top-20 m--margin-bottom-30">
            ...
            <div class="m_datatable m-datatable m-datatable--default m-datatable--loaded m-datatable--scroll">
              <table class="table table-striped table-bordered" id="table-billing-archive" width="100%">
                <thead>
                  <tr>
                    <th>Reference No.</th>
                    <th>Account No.</th>
		...
		<div class="modal-dialog modal-md" role="document">
			<div class="modal-content">
				<div class="modal-header">
					<h5 class="modal-title">Restore Bill</h5>

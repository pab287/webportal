                ...
                <div class="m-portlet__head">
                    <div class="m-portlet__head-caption">
                        <div class="m-portlet__head-title">
                            <h3 class="m-portlet__head-text">Readings</h3>
                        </div>
                    </div>
                                                ...
                                                <ul class="m-nav">
                                                    <li class="m-nav__item">
                                                        <a href="archive" class="m-nav__link btnArchive">
                                                            ...
                                                            <span class="m-nav__link-text">Archive</span>
                                                        </a>
                                                    </li>
                                                </ul>
                                            </div>
                    ...
                    <div class="m-form m-form--label-align-right m--margin-top-10 m--margin-bottom-10">
                        <div class="row align-items-center">
                            ...
                            <div class="col-xl-4 order-1 order-xl-2 m--align-right d-flex flex-row">
                                ...
                                <div class="m-btn-group btn-group" role="group"></div>
    ...
    <div class="modal-dialog" role="document" style="min-width: 60%;">
        <div class="modal-content">
            ...
            <form class="m-form m-form--fit" id="fromCreateReading" method="POST" action="<?php echo site_url('eforms/billing/createreading');?>" enctype="multipart/form-data">
                ...
                <div class="modal-body">
                    ...
                    <div class="m-form m-form--label-align-right m--margin-12">
                        ...
                        <div class="row m--margin-bottom-12">
                            <div class="col-md-6">
                                <div class="form-group m-form__group row">
                                    <label class="col-4 col-form-label"> Reading Date* :</label>
                            ...
                            <div class="col-md-6">
                                <div class="form-group m-form__group row">
                                    <label class="col-4 col-form-label">Reading* :</label>
                                ...
                                <div class="form-group m-form__group row">
                                    <div class="custom-image_container col-12">
                                        <div id="img_primary" class="row">
                                            <img class="picture_null" name="picture" style="max-width: 250px; margin: 0 auto;" src="<?php echo site_url();?>/assets/images/ams/images/no_image.jpg"><br>
                                        </div>
                                        ...
                                        <div class="col-md-12 text-center">
                                            ...
                                            <div class="attachValueContaniner">
                                                <input type='hidden' name="pic[]" class="pic"><br>
                                            </div>
                ...
                <div class="modal-footer">
                    <button type="submit" class="btn btn-primary btnNew">Save</button>
                ...
                <div class="modal-body" id="main_body">
                    <div class="m-form m-form--label-align-right m--margin-10">
                        ...
                        <div class="row">
                            <div class="col-md-6">
                                <div class="form-group m-form__group row">
                                    <label class="col-4 col-form-label">Reference No.* :</label>
...
<div class="modal fade" id="m_generate" tabindex="-1">
    <div class="modal-dialog modal-dialog-centered">
        <div class="modal-content">
            ...
            <div class="modal-body" id="generate_text">Are you sure you wan't to generate bill?</div>

            <div class="modal-footer">
                <button type="submit" class="btn btn-primary btnNew" onclick="generateBill()">Yes</button>
...
<div class="modal fade" id="m_archived" tabindex="-1">
    <div class="modal-dialog modal-dialog-centered">
        <div class="modal-content">
            ...
            <div class="modal-header">
                <h5 class="modal-title">Archive Reading</h5>
            </div>

            <div class="modal-body" id="archive_text"></div>

            <div class="modal-footer">
              <button type="submit" class="btn btn-danger btnArchive" onclick="archiveReading()">Archive</button>
              <button type="button" class="btn btn-secondary" data-dismiss="modal">Cancel</button>
            </div>
        </div>
    </div>

    ...
    <div class="row">
		<div class="col-lg-12">
			<div class="m-portlet m-portlet--mobile">
                ...
                <form id="frm-new_rtw" method="post" action="<?php echo site_url("eforms/return_to_work/set_new_rtw"); ?>">
					    ...
					    <div class="row">
                            <div class="col-md-6 col-sm-12">
                                    ...
                                    <div class="col-md-6 col-sm-6 col-xs-12">
                                        <div class="m-checkbox-list">
                                            <label class="m-checkbox">
                                                <input type="radio" id="return_type_0" class="check_type" name="return_type" value="0" checked />
                                                Unauthorized Absence / No Notification
                                                <span></span>
                                            </label>
                                            <label class="m-checkbox">
                                                <input type="radio" id="return_type_1" class="check_type" name="return_type" value="1">
                                                    Recalled
                                                <span></span>
                                            </label>
                                            <label class="m-checkbox">
                                                <input type="radio" id="return_type_2" class="check_type" name="return_type" value="2">
                                ...
                                <div class="temp-fields">
                                    <?php $this->load->view("eforms/return_work/form_content/unauthorized"); ?>
                                </div>
                            </div>
                            <div class="col-md-6 col-sm-12">
                                <div class="form-group m-form__group row">
                                    <label class="col-md-3 col-lg-3 col-sm-3 col-xs-12 text-right">Reason *</label>
                                    <div class="col-md-9 col-lg-9 col-sm-9 col-xs-12">
                                            <textarea 

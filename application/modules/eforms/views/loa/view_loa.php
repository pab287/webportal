	...
	<div class="row">
		<div class="col-lg-12">
          ...
          <div id="fix-mobile" class="modal-footer"> 
            ...
            <button class="btn btn-danger btnDisapprove_action text-white" id="btndisapprove" onclick="open_dis()">
              Disapprove
            </button>
            <?php endif; ?>
            <?php if((in_array("edit", $this->current_action))): ?>
            <button class="btn btn-warning btnEdit text-white" id="btnedit" onclick="edit_loa()">
              Edit
            </button>
            <?php endif; ?>
            ...
            <button class="btn btn-focus btnHr_note text-white" id="btnnote" onclick="open_note()">
              Note
            </button>
            <?php endif; ?>
            <?php if((in_array("undo_approval", $this->current_action))): ?>
            <button class="btn btn-danger btnUndo_approval text-white" id="btnundoapprove" onclick="open_undo_approve()">
              Undo Approval
            </button>
            <?php endif; ?>
            <?php if((in_array("undo_disapproval", $this->current_action))): ?>
            <button class="btn btn-danger btnUndo_disapproval text-white" id="btnundodisapprove" onclick="open_undo_disapprove()">
              Undo Disapproval
            </button>
            <?php endif; ?>
            <?php if((in_array("restore", $this->current_action))): ?>
            <button class="btn btn-success btnRestore text-white" id="btnundocancel" onclick="open_restore()">
              Restore
            </button>
            <?php endif; ?>
            <?php if((in_array("undo_hr_note", $this->current_action))): ?>
            <button class="btn btn-danger btnUndo_hr_note text-white" id="btnundonote" onclick="open_undo_note()">
              Undo HR Note
            </button>
            <?php endif; ?>
            <?php if((in_array("print", $this->current_action))): ?>
            <button class="btn btn-primary btnPrint text-white" id="btnprint" onclick="print()">
              Print
            </button>
            <?php endif; ?>

            <?php if((in_array("back", $this->current_action))): ?>
             <a class="btn btn-metal btnBack text-white" id="btnback" href="<?php echo site_url("eforms/loa/masterfile");?>">
              <!-- <button class="btn btn-metal btnBack text-white" id="btnback"> -->
                BACK
              <!-- </button> -->
            </a>
            <a class="btn btn-metal btnBack text-white" id="btnback2" href="<?php echo site_url("eforms/loa/archive_loa");?>">
              <!-- <button class="btn btn-metal btnBack text-white" id="btnback2"> -->
                BACK
              <!-- </button> -->
            </a>
            <?php endif; ?>

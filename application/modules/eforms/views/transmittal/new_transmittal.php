                        ...
                        <div class="row">
                            <div class="col-md-5 col-sm-12">
                                ...
                                <div class="form-group m-form__group row">
                                    ...
                                    <div class="col-md-9 col-lg-9 col-sm-9 col-xs-12">
                                        <textarea name="info" rows="3" cols="50" class="form-control"> </textarea>
                                    </div>
                                </div>
                                <div class="form-group m-form__group row">
                                    <label class="col-md-3 col-lg-3 col-sm-3 col-xs-12 col-form-label m--font-bold">
                            ...
                            <div class="col-md-7 col-sm-12">
                                <div class="form-group m-form__group row">
                                    ...
                                    <div class="col-md-4" id="table_v"></div>
                                </div>
                            </div>
                        </div>
                        <br>
                        ...
                        <div class="row">
                            <div class="col-md-6 col-sm-12">
                                ...
                                <div class="form-group m-form__group row" id="delivery_to_ex">
                                    ...
                                    <div class="col-md-9 col-lg-9 col-sm-9 col-xs-12">
                                        <input class="form-control m-input" type="text" name="delivery_to_ex"/>
                                    </div>
                                </div>
                                <div class="form-group m-form__group row">
                                    <label class="col-md-3 col-lg-3 col-sm-3 col-xs-12 col-form-label m--font-bold">
                                ...
                                <div class="form-group m-form__group row" id="row_department">
                                    ...
                                    <div class="col-md-9 col-lg-9 col-sm-9 col-xs-12">
                                        <input class="form-control m-input" type="text" name="department"/>
                                    </div>
                                </div>
                                <div class="form-group m-form__group row">
                                    <label class="col-md-3 col-lg-3 col-sm-3 col-xs-12 col-form-label required m--font-bold">
                                    ...
                                    <div class="col-md-9 col-lg-9 col-sm-9 col-xs-12">
                                        <textarea name="deliver_address" rows="3" cols="50" class="form-control"
                            ...
                            <div class="col-md-6 col-sm-12">
                                <div class="form-group m-form__group row">
                                    ...
                                    <div class="col-md-9 col-lg-9 col-sm-9 col-xs-12">
                                        <div class="m-radio-inline">
                                            <label class="m-radio"><input id="service" type="radio" name="is_service" value="1"
                                                                          onclick="change_service()">Service<span></span></label>
                                ...
                                <div class="form-group m-form__group row" id="service_driver">
                                    ...
                                    <div class="col-md-9 col-lg-9 col-sm-9 col-xs-12">
                                        <input class="form-control m-input" type="text" name="driver" data-validation="required"/>
                                    </div>
                                </div>
                                ...
                                <div class="form-group m-form__group row">
                                    ...
                                    <div class="col-md-9 col-lg-9 col-sm-9 col-xs-12">
                                        <input class="form-control m-input" type="text" name="transporter" data-validation="required" />
                                    </div>
                                </div>
                                <div class="form-group m-form__group row" id="row_courier">
                                    ...
                                    <div class="col-md-9 col-lg-9 col-sm-9 col-xs-12">
                                        <input class="form-control m-input" type="text" name="courier"/>
                                    </div>
                                </div>
                            </div>
                        </div>
                        <div class="row">
                            <div class="col-md-12">
                                <div class="modal-footer">
                                    <button type="submit" id="btnSaveTransmittal" onclick="add_transmittal()" class="btn btn-brand"><i
                                                class="la la-floppy-o"></i> Submit
                                    </button>
                                    <a href="<?php echo site_url("eforms/transmittal/masterfile"); ?>">
                                        <button type="button" style="color: #FFFFFF;" class="btn m-btn--custom btn-metal m-btn text-white btnNew">
                                            Cancel
                                        </button>
                                    </a>
                                </div>
            ...
            <div class="modal fade" id="modal_form_delete" role="dialog">
                <div class="modal-dialog">
                    <div class="modal-content">
                        ...
                        <div class="modal-footer">
                            <button type="button" onclick="delete_content()" class="btn btn-primary m-btn m-btn--custom m-btn--icon  btnNew">yes
                            </button>
                            <button type="button" class="btn btn-metal text-white m-btn m-btn--custom m-btn--icon  btnNew" data-dismiss="modal">no
                            </button>
                        </div>
                        </form>
                    </div><!-- /.modal-content -->
            ...
            <div class="modal-dialog">
                <div class="modal-content">
                    ...
                    <div class="modal-footer">
                        ...
                        <button type="submit" id="btnSave" onclick="save_content()" class="btn btn-primary m-btn  m-btn--icon  btnNew">Save</button>

...
<div class="row">
        ...
        <form id="frm_status_new" action="<?php base_url('eforms/cash_advance/save_cash_advance'); ?>" enctype="multipart/form-data" >
        <input type="hidden" name="csrf_token" value="<?php echo $this->security->get_csrf_hash(); ?>">
              ...
              <div class="col-md-6 col-sm-12">
                ...
                <div class="form-group m-form__group row">
                  ...
                  <div class="col-md-10 col-lg-10 col-sm-10 col-xs-12">
                    <textarea class="form-control m-input" id="company" name="company" rows="4" data-validation="required" disabled></textarea>
                  </div>
                </div>
                <br>
                <div class="form-group m-form__group row">
                  ...
                  <div class="col-md-9 col-lg-9 col-sm-9 col-xs-12">
                    <input class="form-control m-input columnAlign" type="text" name="amt_applied" id="amt_applied" maxlength="22" data-validation="required"/>
                  </div>
                </div>
                <div class="form-group m-form__group row m-radio-inline">
                  <label class="col-md-3 col-lg-3 col-sm-3 col-xs-12 col-form-label">
                    Deduction Type
			            ...
			            <label class="m-radio">
					          <input class="form-control m-input" type="radio" name="deduct_type" value="percentage" checked/>
						          Percentage
						          <span></span>
				          </label>
			            <label class="m-radio">
                ...
                <div class="form-group m-form__group row">
                  ...
                  <div class="col-md-9 col-lg-9 col-sm-9 col-xs-12">
                    <input class="form-control m-input columnAlign" type="text" name="amt_deduct" id="amt_deduct" data-validation="required"/>
                    <p id="help-block" style="color: red; font-size: 12px;">Note: <i> The set amount/percentage shall be deducted from your salary every payday. 20% shall be the minimum rate for CA deduction.</i></p>
                  </div>
                </div>
              </div>
              <!--right-->
              <div class="col-md-6  col-sm-12">
                <div class="form-group m-form__group row">
                  ...
                  <div class="col-md-10 col-lg-10 col-sm-10 col-xs-12">
                    <select id="select_purpose" name="purpose" data-validation="required">
                      <option value="">Select an Option</option>
                    </select>
                  </div>
                </div>
                <div id="other-purpose" class="form-group m-form__group row" style="display: none">
                  <label class="col-md-2 col-lg-2 col-sm-2 col-xs-12 col-form-label"></label>
                  <div class="col-md-10 col-lg-10 col-sm-10 col-xs-12">
                    <textarea name="other_purpose" id="other_purpose" class="form-control" rows="4" placeholder="Please Specify" data-validation="required"></textarea>
                  </div>
                </div>
                <div class="form-group m-form__group row">
                  <label class="col-md-2 col-lg-2 col-sm-2 col-xs-12 col-form-label">
               ...
               <template v-if="counter > 0">
                  <div class="col-md-6 col-lg-6 col-sm-12" v-for="(row, index) in rows">
                      <div class="m-portlet m-portlet--bordered m-portlet--bordered-semi m-portlet--rounded mb-3">
                          <div class="m-portlet__body pb-1 pt-1 pl-3">
                              ...
                              <input type="hidden" name="file_type[]" :value="row.file_type" />
                              <div class="m-widget4" style="overflow-wrap: anywhere;">
                                  <div class="m-widget4__item">
                                      ...
                                      <div class="m-widget4__info">
                                          ...
                                          <p class="m-widget4__sub mb-0"><span class="m--font-boldest">File Type: {{row.file_type}}</span></p>						 		 
                                      </div>
            ...
            <div class="col-xl-12 order-1 order-xl-2 m--align-right">
              <button type="submit" onclick="save()" class="btn btn-info m-btn m-btn--custom m-btn--icon m-btn--air m-btn--box btn-submit btnNew">
                <span>

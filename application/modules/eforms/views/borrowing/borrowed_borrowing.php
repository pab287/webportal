<div class="m-content">
                    ...
                    <div class="row align-items-center">
                        <div class="col-xl-8 order-2 order-xl-1">
                            <div class="form-group m-form__group row align-items-center">
                                <div class="col-md-4">
									<a onclick="mass_open()" class=" text-white btn btn-success m-btn m-btn--custom m-btn--icon m-btn--air m-btn--pill btnNew">
										<span>
  ...
  <div class="modal fade" id="modal_form_return" role="dialog">
                ...
                <div class="modal-body form">
                  <form action="#" id="form_return" class="form-horizontal">
				   ...
				   <div class="form-group">
                    ...
                    <div class="col-md-12">
					<div class='input-group date' id="date_returned">
					<input class="form-control m-input" type="text" name="date_returned" data-validation="required"  />
                  <span class="input-group-addon">
                    ...
                    <div class="col-md-12">
                     <textarea name="return_remarks"  class="form-control" data-validation="required"> </textarea> 
                    </div>
                    </div>
                   ...
                   <div class="modal-footer">
                     ...
                     <button type="submit" id="btnSave" onclick="return_item()" class="btn btn-success m-btn m-btn--icon  btnNew">Return</button>
					 <button type="submit" id="btnSave2" onclick="mass_return_item()" class="btn btn-success m-btn  m-btn--icon  btnNew">Mass Return</button>
   ...
   <div class="modal fade" id="modal_form_extend" role="dialog">
            <div class="modal-dialog">
              <div class="modal-content">
                <div class="modal-header">
                  <h3 class="modal-title"></h3>
                ...
                <div class="modal-body form">
                  <form action="#" id="form_extend" class="form-horizontal">
                    <input type="hidden" value="" name="id_extend"/> 
                   <input type="hidden" name="csrf_token" value="<?php echo $this->security->get_csrf_hash(); ?>">
				   <div class="form-group">
                    <label class="control-label col-md-4">New Due Date</label>
                    <div class="col-md-12">
					<div class='input-group date' id="new_due">
					<input class="form-control m-input" type="text" name="new_due" data-validation="required"  />
                  <span class="input-group-addon">
                          <i class="la la-calendar glyphicon-th"></i>
                        </span> 
						</div>
                    ...
                    <div class="col-md-12">
                     <textarea name="due_reason"  class="form-control" data-validation="required"> </textarea> 
                    </div>
                    </div>
                   ...
                   <div class="modal-footer">
                     ...
                     <button type="submit" id="btnSave" onclick="extend()" class="btn btn-primary m-btn m-btn--icon  btnNew">Ok</button>
                      <button type="button" class="btn btn-metal text-white m-btn m-btn--icon  btnNew" data-dismiss="modal">Cancel</button>
                    </div>
                    </form>
                  </div><!-- /.modal-content -->

                ...
                <div class="modal-body form">
                  ...
                  <span class="input-group-addon">
                   ...
                   <div class="modal-footer">
                     ...
                     <button type="submit" id="btnSave" onclick="return_item()" class="btn btn-success m-btn m-btn--custom m-btn--icon btnSave">Return</button>
                      <button type="button" class="btn btn-default m-btn m-btn--custom m-btn--icon  btnClose" data-dismiss="modal">Cancel</button>
                    </div>
                    </form>
                  </div><!-- /.modal-content -->
                </div>

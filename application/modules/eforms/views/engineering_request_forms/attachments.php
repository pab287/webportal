                ...
                <div class="row align-items-center">
                    <div class="col-xl-8 order-2 order-xl-1">
                        <div class="form-group m-form__group row align-items-center">
                            <div class="col-md-4">
                                <a id="addNew" href="javascript:void(0);" class="btn btn-accent m-btn m-btn--custom m-btn--icon m-btn--air m-btn--pill btnNew" data-toggle="modal" data-target="#newAttachmentModal">
                                    <span>
...
<div class="modal fade" id="newAttachmentModal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel">

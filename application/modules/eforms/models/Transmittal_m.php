    ...
    class Transmittal_m extends CI_Model {
        ...
        public function get_all_transmittal_items_count($query_builder=null, $search = null, $isAdvanceSearch = false, $_data = null, $status = null, $view_dept) {
            ...
            if ($isAdvanceSearch) {
                ...
                if (isset($_data['delivered_to']) && $_data['delivered_to']) {
                    $this->db->like('CONCAT(CASE WHEN CAST(a.ship_to AS DECIMAL) THEN CONCAT(e.firstname, " ", e.lastname) ELSE a.ship_to END, a.company_to, a.department_to, a.position_to, a.ship_to_address)', $_data['delivered_to'], 'both');
                }

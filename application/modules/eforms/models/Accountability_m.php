...
class Accountability_m extends CI_Model {
    ...
    function newVehicleTemp() {
        ...
        $rowData = $this->get_new_vehicle_temp_post($code, $limit, $offset, $sortBy, $sortOrder);
        $rowCount = $this->get_new_vehicle_temp_post_count($code);
    ...
    function multipleTemp() {
        ...
        $rowData = $this->get_multiple_temp_post($code, $limit, $offset, $sortBy, $sortOrder);
        $rowCount = $this->get_multiple_temp_post_count($code);

            ...
            <div class="m-portlet m-portlet--mobile">
                ...
                <div class="m-portlet__body">
                    ...
                    <div class="m_datatable m-datatable m-datatable--default m-datatable--loaded m-datatable--scroll">
                        <table class="table table-striped table-bordered" id="table-item" width="100%">
                            <thead>
                            <tr>
                                <th>Name</th>
                                <th>Category</th>
                            ...
                            <div class="modal-dialog">
                                <div class="modal-content">
                                    ...
                                    <div class="modal-footer">
                                        <button type="button" onclick="delete_item()" class="btn btn-primary m-btn m-btn--custom m-btn--icon  btnNew">
                                            Yes
                                        </button>
                ...
                <div class="modal fade" id="modal_form_item" role="dialog">
                    <div class="modal-dialog">
                        <form action="#" id="form_item" class="form-horizontal">
                            <div class="modal-content">
                                ...
                                <div class="modal-body form">
                                    ...
                                    <div class="col-md-12">
                                        <select id="select2_category" name="category" data-validation="required">
                                        </select>
                                    </div>
                                </div>
                                </div>
                                <div class="modal-footer">
                                    <button type="submit" id="btnSave" onclick="save_item()"

                            ...
                            <div class="modal-dialog">
                                <div class="modal-content">
                                    ...
                                    <div class="modal-footer">
                                        <button type="button" onclick="delete_project()" class="btn btn-primary m-btn m-btn--custom m-btn--icon  btnNew">
                                            Yes
                                        </button>
                    ...
                    <div class="modal-dialog">
                        <form action="#" id="form_project" class="form-horizontal">
                            <div class="modal-content">
                                ...
                                <div class="modal-footer">
                                    <button type="submit" id="btnSave" onclick="save_project()"

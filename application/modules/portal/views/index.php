...
<?php $session = $this->session;
    ...
    $select = array("id","idno","biometricno","lastname","firstname","middlename","email","position","employee_status","curr_addr","str_addr","city","postal","pic_filename");
    ...
    $avatar = file_exists($profile_image_path) ? $profile_image_path : "assets/images/profile/no_image.jpg";
    ...
    $loa_module = in_array("eforms_loa", $privArr) ? true : false;
    $tr_module = in_array("tr_masterfile", $privArr) ? true : false;
    $to_module = in_array("to_masterfile", $privArr) ? true : false;
    $ship_module = in_array("ship_masterfile", $privArr) ? true : false;
    $accountability_module = in_array("accountability_masterfile", $privArr) ? true : false;
    $overtime_module = in_array("overtime_masterfile", $privArr) ? true : false;
    $ca_module = in_array("ca_masterfile", $privArr) ? true : false;
    $rtw_module = in_array("eforms_rtw_masterfile", $privArr) ? true : false;
    $borrowing_module = in_array("borr_masterlist", $privArr) ? true : false;
    $billing_module = in_array("billing_masterfile", $privArr) ? true : false;
?>

<html lang="en" class="wf-poppins-n3-active wf-poppins-n6-active wf-poppins-n7-active wf-roboto-n3-active wf-poppins-n4-active wf-poppins-n5-active wf-roboto-n4-active wf-roboto-n5-active wf-roboto-n6-active wf-roboto-n7-active wf-active">
    ...
    <head>
        ...
        <style type="text/css">
            ...
            .attendance-legend-dropdown .dropdown-item {
                white-space: nowrap;
            }
            ...
            /* .attendance-mobile-card.is-late {
                border-left: 3px solid #ffb822;
            } */

            .attendance-mobile-card.is-absent {
                background: #ececf3;
                border-left: 3px solid #d32f2fde;
            }

            .attendance-mobile-card.is-lacking {
                background: #f7f8f6;
                border-left: 3px solid #f4433678;
            }

            .attendance-mobile-card.is-multiple {
                background: #f7f8f6;
                border-left: 3px solid #ffa7267d;
            }

            .attendance-mobile-card.is-ontime {
                background: #f7f8f6;
            }
            ...
            .attendance-mobile-status.is-ontime {
                color: #2e8c65;
                background: #dff2e8;
            }

            .attendance-mobile-status.is-late {
                color: #000000;
                background: #ffb822;
            }

            .attendance-mobile-status.is-lacking {
                color: #000000;
                background: #f4433678;
            }

            .attendance-mobile-status.is-multiple {
                color: #ffffff;
                background: #ffa7267d;
            }

            .attendance-mobile-status.is-absent {
                color: #FFFFFF;
                background: #d32f2fde;
            }

            .attendance-mobile-status.is-restday {
                color: #5f6675;
                background: #e6e8ec;
            }

            .attendance-mobile-status.is-holiday {
                color: #486b9c;
                background: #dce8f8;
            }
            ...
            .attendance-mobile-time.is-accent {
                color: #4259d8;
            }

            .attendance-mobile-time.is-late {
                color: #b54444;
            }
    ...
    <body class="m-page--fluid m--skin- m-content--skin-light2 m-header--fixed m-header--fixed-mobile m-aside--offcanvas-default">
                            ...
                            <div class="m-stack__item m-topbar__nav-wrapper">
                                <div class="m-topbar__nav m-nav m-nav--inline">
                                    ...
                                    m-dropdown--mobile-full-width m-dropdown--skin-light"
                                        ...
                                        <!-- DROPDOWN -->
                                        <?php $this->load->view(
                                            "core/templates/user_profile/dropdown_info",
                                            array("avatar" => $avatar, "user" => $user),
                                            FALSE
                                        ); ?>
                                    </li>
                                </div>
                                            ...
                                            <template v-else>
                                                    ...
                                                    <div class="m-widget1__item">
                                                        <div class="row m-row--no-padding align-items-center">
                                                            <div class="col">
                                                                ...
                                                                <span class="m-widget1__desc" v-text="formatDate(payslip.data.pay_date).toUpperCase()"></span>
                                                            </div>
                                                            <div class="col m--align-right">
                                                                <h3 class="m-widget1__title">
                                                                    COVERAGE DATE
                                                                </h3>
                                                                <span class="m-widget1__desc" v-text="formatDateCoverage(payslip.data.date_start, payslip.data.date_end).toUpperCase()"></span>
                                                            </div>
                                                        </div>
                                                    </div>
                                                    <div class="m-widget1__item">
                                                ...
                                                <template v-else>
                                                    <div class="m-widget1__item">
                                                        <div class="row m-row--no-padding align-items-center">
                                                            <div class="col text-center">
                                                                <h3 class="m-widget1__title p-0">NO PAYSLIP AVAILABLE</h3>
                                                            </div>
                                                        </div>
                                                    </div>
                                                </template>
        ...
        <!-- end::Body -->
        <?php $version = filemtime(FCPATH.'assets/js/portal/portal_script.js'); ?>
        <script src='<?php echo base_url("assets/js/portal/portal_script.js?v=$version"); ?>'></script>
    </body>
</html>

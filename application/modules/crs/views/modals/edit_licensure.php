<div class="modal-dialog" role="dialog">
    <div class="modal-content">
        <form id="employee-data-update-licensure" method="post" action="<?= base_url("crs/online_registration/update_licensure"); ?>">
            ...
            <div class="modal-body">
                ...
                <div class="form-group">
                    ...
                    <div class="input-group date-range">
                        ...
                        <input id="exam_date" type="text" name="exam_date" autocomplete="off" data-validation="required"
                ...
                <div class="form-group">
                    ...
                    <input id="license_no" name="license_no" type="text" maxlength="50" size="50" autocomplete="off" data-validation="required"

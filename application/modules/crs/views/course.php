            ...
            <div class="m-portlet m-portlet--mobile">
                ...
                <div class="m-portlet__body">
                    ...
                    <div class="m_datatable m-datatable m-datatable--default m-datatable--loaded m-datatable--scroll">
                        <table class="table table-striped table-bordered" id="table-course" width="100%">
                            <thead>
                            <tr>
                                <th>Course</th>
                                <th>Action</th>
                        ...
                        <div class="modal-dialog">
                            <div class="modal-content">
                                ...
                                <div class="modal-footer">
                                    <button type="button" onclick="delete_course()" class="btn btn-primary m-btn m-btn--custom m-btn--icon  btnNew">
                                        Yes
                                    </button>
                    ...
                    <div class="modal-dialog">
                        <div class="modal-content">
                            ...
                            <form action="#" id="form_course" class="form-horizontal"
                                  onsubmit="save_course(); return false;">
                                <div class="modal-body form">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-md-12">
                                            <input type="text" name="course" class="form-control" data-validation="required">
                                        </div>
                                    </div>
                                </div>
                                <div class="modal-footer">

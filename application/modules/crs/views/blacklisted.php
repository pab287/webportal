    ...
    <div class="m-portlet m-portlet--mobile">
        ...
        <div class="m-portlet__body">
                    ...
                    <div class="col-xl-8 order-2 order-xl-1">
                        ...
                        <div class="col-xl-4 order-1 order-xl-2 m--align-right d-flex flex-row">
                            <div class="m-input-icon m-input-icon--left" style="border: 1px solid #c3c3c3;">
                                <input type="text" class="form-control m-input m-input--solid" placeholder="Search..." id="blacklistedSearch">
            ...
            <div class="m_datatable m-datatable m-datatable--default m-datatable--loaded m-datatable--scroll table-responsive-sm">
                <table class="table table-hover table-bordered" aria-label="table-blacklisted" id="table-blacklisted" style="word-break: break-word">
                    <thead>
                    <tr>
                      <th></th>

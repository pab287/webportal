                                ...
                                <div class="row mt-2">
                                    <div class="col-12">
                                        <div class="form-group">
                                            ...
                                            <input type="text" name="position" id="position" class="form-control" data-validation="required" autocomplete="off">
                                        </div>
                                    </div>
                                    <div class="col-12">
                                        <div class="form-group">
                                            <label class="form-control-label required">Employer</label>
                                            <input type="text" name="employer" id="employer" class="form-control" data-validation="required" autocomplete="off">
                                        </div>
                                    </div>
                                </div>
                            </form>

<div class="m-content">
			...
			<div class="m-portlet m-portlet--mobile">
											...
											<div class="m-dropdown__content">
												<ul class="m-nav">
													...
													<li class="m-nav__item">
														<a href="<?=base_url('hris/masterfile/archived_license') ?>" class="m-nav__link btnView">
				...
				<div class="m-portlet__body">
					...
					<div class="m_datatable m-datatable m-datatable--default m-datatable--loaded m-datatable--scroll table-responsive">
						<table class="table table-striped table-bordered" id="table-license" width="100%">
							<thead>
								<tr>
									<th>Code</th>
									<th>Type</th>
	...
	<div class="modal fade" id="modalRemoveLicense" tabindex="-1" role="dialog">
        <div class="modal-dialog" role="document">
            <div id="modalTempContainer" class="modal-content">
                <div class="modal-header">
				...
				<div class="modal-footer">
					...
					<button type="button" class="btn btn-primary btn-submit btnDelete btnRemoveCurrentLicense">Yes</button>
            	</div>
            </div>
        </div>
    </div>

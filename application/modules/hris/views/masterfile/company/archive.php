<div class="m-content">
            ...
            <div class="m-portlet m-portlet--mobile">
                                            ...
                                            <div class="m-dropdown__content">
                                                <ul class="m-nav">
                                                    ...
                                                    <li class="m-nav__item">
                                                        ...
                                                        <a href="<?=base_url('hris/masterfile/company') ?>" class="m-nav__link btnBack">
                                                            <i class="m-nav__link-icon flaticon-open-box"></i>
                                                            <span class="m-nav__link-text">
																Back to Masterfile
															</span>
                ...
                <div class="m-portlet__body">
                    ...
                    <div class="m_datatable m-datatable m-datatable--default m-datatable--loaded m-datatable--scroll table-responsive">
                        <table class="table table-striped table-bordered" id="table-archive-company" width="100%">
                            <thead>
                            <tr>
                                <th>Image</th>
                                <th>Code</th>
    ...
    <div class="modal fade" id="modalRestoreCompany" tabindex="-1" role="dialog">
        <div class="modal-dialog" role="document">
            <div id="modalTempContainer" class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title" id="exampleModalLabel"><i class="la la-trash mr-2"></i>Restore Company</h5>
                    <button type="button" class="close modalClose" aria-label="Close" data-dismiss="modal">
                        <span aria-hidden="true">×</span>
                    </button>
                </div>
                <div class="modal-body">
                    ...
                    <p>Are you sure you want to restore this company on the list?</p>
                </div>
                <div class="modal-footer">
                    <button class="btn btn-danger btnClose" data-dismiss="modal">No</button>
                    <button type="button" class="btn btn-primary btn-submit btnDelete btnRestoreCurrentCompany">Yes
                    </button>
                </div>
            </div>
        </div>

<div class="row">
    <div class="col-xl-3 col-lg-3 col-md-3 col-sm-12">
        <form id="frm-filter-hris-certificate" class="m-form" method="post">
        <input type="hidden" name="<?php echo $this->security->get_csrf_token_name(); ?>" value="<?php echo $this->security->get_csrf_hash(); ?>">
            <div class="m-portlet m-portlet--head-sm mb-2" data-portlet="true" id="m_portlet_tools-certificate_report">
                ...
                <div id="tempFilterCertificate" class="m-portlet__body">
                    <div id="tempFilterByCertificate" class="row">
                    ...
                    <div class="row">
                        ...
                        <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12">
                            <div class="form-group">
                                <label class="m--font-bolder">TYPE <span class="m-form__help p-0" style="text-transform: none; font-width: 600;">( Optional )</span></label>
                        ...
                        <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12">
                            <div class="form-group">
                                <label class="m--font-bolder">LICENSES AND CERTIFICATIONS TITLE <span class="m-form__help p-0" style="text-transform: none; font-width: 600;">( Optional )</span></label>
                                <input type="text" name="licenses" id="licenses" class="form-control" />
                            </div>
                        </div>
                    </div>
                </div>
                <div class="m-portlet__foot text-right">
                    <button type="button" 
                        ...
                        onclick="resetFilterCertificate(this)">
                        <span>
    ...
    <div class="col">
        <div class="m-portlet m-portlet--bordered m-portlet--rounded">
            <div id="filteredContentCertification" class="m-portlet__body">
                <template v-if="count == 0">
                <div class="alert alert-danger m-alert m-alert--air m-alert--outline" role="alert">
                    <strong>Employee Licenses and Certifications Report</strong> No data / record(s) found.				  	
                </div>
                </template>
                <template v-else>
                <!--begin: Datatable -->
                        ...
                        <div class="col-5 col-xl-5 col-lg-5 col-md-5 col-sm-12 text-left d-flex flex-row-reverse mb-2">
                            <div class="flex-grow-0 flex-shrink-0">
                                <button type="button" class="btn btn-warning btnPrint m-btn m-btn--icon text-white"
                                        @click="exportExcelCertificateSeminar(event)">
                                    <span>
                            ...
                            <div class="flex-grow-0 flex-shrink-0 mr-2">
                                <button type="button" class="btn btn-brand btnPrint m-btn m-btn--icon"
                                        @click="printCertificateSeminar(event)">
                                    <span>
                ...
                <div class="m_datatable m-datatable m-datatable--default m-datatable--loaded m-datatable--scroll table-responsive">
                    <table class="table table-striped table-bordered" id="table-certificate_report" width="100%"></table>
                </div>
                <!--end: Datatable -->
                </template>
            </div>

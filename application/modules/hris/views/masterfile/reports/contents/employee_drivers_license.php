<div class="row">
    <div class="col-xl-3 col-lg-3 col-md-3 col-sm-12">
        <form id="frm-filter-hris-drivers_license" class="m-form" method="post">
        <input type="hidden" name="<?php echo $this->security->get_csrf_token_name(); ?>" value="<?php echo $this->security->get_csrf_hash(); ?>">
            <div class="m-portlet m-portlet--head-sm mb-2" data-portlet="true" id="m_portlet_tools-drivers_license_report">
                ...
                <div id="tempFilterDriversLicense" class="m-portlet__body">
                    <div id="tempFilterByDriversLicense" class="row">
                ...
                <div class="m-portlet__foot text-right">
                    <button type="button" 
                        ...
                        onclick="resetFilterDriversLicense(this)">
                        <span>
    ...
    <div class="col">
        <div class="m-portlet m-portlet--bordered m-portlet--rounded">
            <div id="filteredContentLicenses" class="m-portlet__body">
                <template v-if="count == 0">
                <div class="alert alert-danger m-alert m-alert--air m-alert--outline" role="alert">
                    <strong>Employee Drivers License Report</strong> No data / record(s) found.				  	
                </div>
                </template>
                <template v-else>
                <!--begin: Datatable -->
                        ...
                        <div class="col-5 col-xl-5 col-lg-5 col-md-5 col-sm-12 text-left d-flex flex-row-reverse mb-2">
                            <div class="flex-grow-0 flex-shrink-0">
                                <button type="button" class="btn btn-warning btnPrint m-btn m-btn--icon text-white"
                                        @click="exportExcelDriversLicense(event)">
                                    <span>
                            ...
                            <div class="flex-grow-0 flex-shrink-0 mr-2">
                                <button type="button" class="btn btn-brand btnPrint m-btn m-btn--icon"
                                        @click="printDriversLicense(event)">
                                    <span>
                ...
                <div class="m_datatable m-datatable m-datatable--default m-datatable--loaded m-datatable--scroll table-responsive">
                    <table class="table table-striped table-bordered" id="table-drivers_license_report" width="100%"></table>
                </div>
                <!--end: Datatable -->
                </template>
            </div>

<div class="m-content">
			...
			<div class="m-portlet m-portlet--mobile">
											...
											<div class="m-dropdown__content">
												<ul class="m-nav">
													...
													<li class="m-nav__item">
														...
														<a href="<?=base_url('hris/masterfile/archived_departments') ?>" class="m-nav__link btnView">
															<i class="m-nav__link-icon flaticon-open-box"></i>
															<span class="m-nav__link-text">
																Archives
															</span>
				...
				<div class="m-portlet__body">
						...
						<div class="row align-items-center">
							<div class="col-xl-8 order-2 order-xl-1">
								<div class="form-group m-form__group row align-items-center">
									<div class="col-md-12">
										<a href="javascript:void(0);" class="btn btn-accent m-btn m-btn--custom m-btn--icon m-btn--air m-btn--pill btnNew btnNewDepartment">
											<span>
					...
					<div class="m_datatable m-datatable m-datatable--default m-datatable--loaded m-datatable--scroll table-responsive">
						<table class="table table-striped table-bordered" id="table-department" width="100%">
							<thead>
								<tr>
									<th>Code</th>
									<th>Department</th>
	...
	<div class="modal fade" id="modalRemoveDepartment" tabindex="-1" role="dialog">
        <div class="modal-dialog" role="document">
            <div id="modalTempContainer" class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title" id="exampleModalLabel">Remove Department</h5>
                    <button type="button" class="close modalClose" aria-label="Close" data-dismiss="modal">
                        <span aria-hidden="true">×</span>
                    </button>
                </div>
                <div class="modal-body">
					...
					<p>Are you sure you want to remove this department on the list?</p>
				</div>
				<div class="modal-footer">
					<button class="btn btn-danger btnClose" data-dismiss="modal">No</button>
					<button type="button" class="btn btn-primary btn-submit btnDelete btnRemoveCurrentDepartment">Yes</button>
            	</div>
            </div>
        </div>
    </div>

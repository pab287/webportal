<li class="m-nav__item m-topbar__quick-actions m-topbar__quick-actions--img m-dropdown m-dropdown--large m-dropdown--header-bg-fill m-dropdown--arrow m-dropdown--align-right m-dropdown--align-push m-dropdown--mobile-full-width m-dropdown--skin-light" data-dropdown-toggle="click" aria-expanded="true">
    ...
    <div class="m-dropdown__wrapper">
        ...
        <div class="m-dropdown__inner">
            <div class="m-dropdown__header m--align-center" style="background: url('<?php echo site_url("assets/app/media/img/misc/quick_actions_bg.jpg"); ?>'); background-size: cover;">
                    ...
                    <div class="m-scrollable" data-scrollable="false" data-max-height="380" data-mobile-max-height="200">
                        <div class="m-nav-grid m-nav-grid--skin-light">
                            <div class="m-nav-grid__row">
                                <a href="javascript:void()" class="m-nav-grid__item" data-toggle="modal" data-target="#m_modal_settings">
                                    <i class="m-nav-grid__icon flaticon-cogwheel-2"></i>
                                    <span class="m-nav-grid__text">
                                        Notification Settings
                                    </span>
                                </a>
                                <a href="javascript:void()" class="m-nav-grid__item">

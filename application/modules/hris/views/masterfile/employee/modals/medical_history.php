...
<form id="form-medical_history" method="post" action="<?php echo site_url("hris/masterfile/set_modal_medical_history"); ?>">
...
<div class="modal-body">
    ...
    <div class="form-group">
        ...
        <span class="btn btn-success fileinput-button btn-sm pull-right">
            ...
            <input type="file" id="fileupload_medical" name="files">
            <input type="hidden" id="medical_attachment" name="medical_attachment" />
        </span>

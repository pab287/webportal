                            ...
                            <table border="0" align="center" width="980" cellpadding="0" cellspacing="0" class="container980">
								<tr>
                                    <td align="center" height="70" style="height:70px;">
                                        ...
                                        <?php if($is_weekly): ?>
                                            <h2 style="font-family: Quicksand, Calibri, sans-serif; margin-top: 15px; color:#343434; text-transform: uppercase;">Separated Employees - Weekly</h2>
                                        <?php else: ?>
                                            <h2 style="font-family: Quicksand, Calibri, sans-serif; margin-top: 15px; color:#343434; text-transform: uppercase;">Separated Employees - Monthly</h2>
                                        <?php endif; ?>
                            ...
                            <tbody>
                                ...
                                <tr>
                                    <td align="left" style="color: #888888; font-size: 16px; font-family: 'Work Sans', Calibri, sans-serif; line-height: 24px;">
                                        <div style="line-height: 24px">The following <strong style="color: #000000;">Separated Employee(s)</strong> as of <strong style="color: #ff0000;"><?php echo (isset($dateStart) && $dateStart)? date("F d, Y", strtotime($dateStart)): date("F d, Y"); ?></strong> up to <strong style="color: #ff0000;"><?php echo (isset($dateEnd) && $dateEnd)? date("F d, Y", strtotime($dateEnd)): date("F d, Y"); ?></strong>. <br>A total of <strong>(<?php echo $count; ?>) employee(s)</strong> has been separated.</div>
                                    </td>
                                </tr>
                                <tr>
                                ...
                                <tr>
                                    <td align="left" style="color: #888888; font-size: 16px; font-family: 'Work Sans', Calibri, sans-serif; line-height: 24px;">
                                        <div style="line-height: 24px"><strong>No Separated Employee(s)</strong> as of <strong style="color: #ff0000;"><?php echo (isset($dateStart) && $dateStart)? date("F d, Y", strtotime($dateStart)): date("F d, Y"); ?></strong> up to <strong style="color: #ff0000;"><?php echo (isset($dateEnd) && $dateEnd)? date("F d, Y", strtotime($dateEnd)): date("F d, Y"); ?></strong>.</div>
                                    </td>
                                </tr>
                                <?php endif; ?>
                            </tbody>
                        ...
                        <table border="0" align="center" width="980" cellpadding="0" cellspacing="0" class="container980">
								...
								<thead>
									<tr>
										...
										<th align="right" style="color: #343434; font-size: 14px; font-family: Quicksand, Calibri, sans-serif; font-weight:700;letter-spacing: 0px; line-height: 18px;">SEPARATED DATE</th>
									</tr>
								</thead>
								<tbody>
                                    <?php foreach ($data as $key => $employee): ?>
                                        <tr>
                                            ...
                                            <td align="right" width="105" v-align="top" style="vertical-align: text-top; color: #343434; font-size: 14px; font-family: 
                                                'Work Sans', Calibri, sans-serif; line-height: 18px; font-weight: 500;"><?php echo $employee->date_end; ?></td>   
                                        </tr>
                                    <?php endforeach; ?>
								</tbody>
							</table>

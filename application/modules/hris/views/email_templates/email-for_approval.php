                            ...
                            <table border="0" align="center" width="980" cellpadding="0" cellspacing="0" class="container980">
								<tr>
                                    <td align="center" height="70" style="height:70px;">
                                        ...
                                        <h2 style="font-family: Quicksand, Calibri, sans-serif; margin-top: 15px; color:#343434; text-transform: uppercase;">Payroll Information - For Approval</h2>
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        <td align="left" style="color: #888888; font-size: 16px; font-family: 'Work Sans', Calibri, sans-serif; line-height: 24px;">
                                            <div style="line-height: 24px">Payroll information of <strong><?php echo isset($employee_name) && $employee_name ? $employee_name: "No Assigned Employee Name"; ?></strong> has been updated by <strong><?php echo isset($created_by) && $created_by ? $created_by: "No Created By Name"; ?></strong> as of <strong><?php echo isset($date) && $date ? date("F d, Y h:i A", strtotime($date)): date("F d, Y h:i A"); ?></strong> and is currently in need of approval.</div>
                                        </td>
                                    </tr>
                                    <tr>
                                    ...
                                    <tr>
                                        <td align="left" style="color: #888888; font-size: 16px; font-family: 'Work Sans', Calibri, sans-serif; line-height: 24px;">
                                            <div style="line-height: 24px">These are the information that has been altered <?php echo $list_header ? ", ".strtoupper($list_header): ""; ?>:</div>
                                        </td>
                                    </tr>
                                    <tr>
                                        <td height="30" style="font-size: 30px; line-height: 30px;">&nbsp;</td>
                                    ...
                                    <tr>
                                        <td align="center">
                                            <table border="0" align="center" width="580" cellpadding="0" cellspacing="0" class="container580">
                                                ...
                                                <thead>
                                                    <tr>
                                                        <th align="left" style="color: #888888; font-size: 16px; font-family: 'Work Sans', Calibri, sans-serif; line-height: 24px; font-weight: bold;">Description</th>
                                                        <th align="left" style="color: #888888; font-size: 16px; font-family: 'Work Sans', Calibri, sans-serif; line-height: 24px; font-weight: bold;">Value</th>
                                                    </tr>
                                                </thead>
                                                <tbody>
                                    ...
                                    <tr>
                                        <td align="left" style="color: #888888; font-size: 16px; font-family: 'Work Sans', Calibri, sans-serif; line-height: 24px;">
                                            <div style="line-height: 24px"><strong>Note:</strong> The information above can be found on the employee masterfile page.</div>
                                        </td>
                                    </tr>
                                </tbody>
                            </table>

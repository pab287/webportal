...
<div id="registration" class="m-content">
    ...
    <div class="container-fluid py-5 px-0">
        <div class="col-lg-12 pb-4">
            <h1 class="text-center font-weight-bold">New Employee Form</h1>
        </div>
        <div class="col-lg-12">
            <div class="m-portlet">
                ...
                <div class="m-portlet__body">
                    <section class="signup-step-container">
                        ...
                        <div id="user_data" class="row d-flex justify-content-center">
                            <div class="col-md-12">
                                <div class="row m--margin-bottom-10">
                                    <div class="col-sm-6 col-md-6 col-lg-4 col-xl-4 text-center">
                                        <small class='text-muted'>COMPANY</small>
                                        <br>
                                        <label class="col-form-label p-0"><span class='m--font-bold' id="company_label" style='text-transform: uppercase;'></span></label>
                                    </div>
                                    <div class="col-sm-6 col-md-6 col-lg-4 col-xl-4 text-center">
                                        <small class='text-muted'>DEPARTMENT</small>
                                        <br>
                                        <label class="col-form-label p-0"><span class='m--font-bold' id="department_label" style='text-transform: uppercase;'></span></label>
                                    </div>
                                    <div class="col-sm-6 col-md-6 col-lg-4 col-xl-4 text-center">
                                        <small class='text-muted'>POSITION</small>
                                        <br>
                                        <label class="col-form-label p-0"><span class='m--font-bold' id="position_label" style='text-transform: uppercase;'></span></label>
                                    </div>
                                </div>
                                <hr>
                                <div class="wizard">
                                ...
                                <div id="login-box" class="login-box">
                                    <div class="tab-content" id="main_form">
                                        <div class="tab-pane active" role="tabpanel" id="step1">
                                            <form id="user-data" role="form" class="form-group">
                                                ...
                                                <template v-if="count > 0">
                                                    <input type="hidden" id="emp_id" name="id" :value="row.id">
                                                </template>
                                                        ...
                                                        <div class="row">
                                                            <div class="col-md-3">
                                                                <div class="form-group">
                                                                    ...
                                                                    <input class="form-control" type="text" name="firstname" data-validation="required"> 
                                                                </div>
                                                            </div>
                                                            <div class="col-md-3">
                                                                <div class="form-group">
                                                                    <label class="required">Last Name</label> 
                                                                    <input class="form-control" type="text" name="lastname" data-validation="required">
                                                                </div>
                                                            </div>
                                                            <div class="col-md-3">
                                                                <div class="form-group">
                                                            ...
                                                            <div class="col-md-3">
                                                                <div class="form-group">
                                                                    <label>Suffix</label> 
                                                                    <input class="form-control" type="text" name="suffix" placeholder="( Optional )">
                                                                </div>
                                                            </div>
                                                        </div>
                                                        <hr>
                                                            ...
                                                            <div class="col-md-3">
                                                                <div class="form-group">
                                                                    ...
                                                                    <div class="input-group">
                                                                        ...
                                                                        <input type="text" name="tel_no" class="form-control m-input" maxlength="12" size="12" autocomplete="off" placeholder="( Optional )">
                                                                    </div>
                                                                </div>
                                                            </div>
                                                            <div class="col-md-3">
                                                                <div class="form-group">
                                                                    ...
                                                                    <div class="input-group">
                                                                        ...
                                                                        <input type="text" name="mobile_no" class="form-control m-input" maxlength="12" size="12" autocomplete="off" placeholder="( Optional )">
                                                                    </div>
                                                                </div>
                                                            </div>
                                                            <div class="col-md-4">
                                        ...
                                        <div class="tab-pane" role="tabpanel" id="step2">
                                            <form id="additional-data" role="form" class="form-group">
                                                <input type="hidden" name="csrf_token" value="<?php echo $this->security->get_csrf_hash(); ?>" autocomplete="off">
                                                <input type="hidden" name="personnel_request_id" id="personnel_request_id">
                                                <template v-if="count > 0">
                                                    <input type="hidden" id="emp_id" name="id" :value="row.id">
                                                    ...
                                                    <div class="m-portlet__body">
                                                        <div class="row">
                                                            <div class="col-md-3">
                                                                <div class="form-group">
                                                                    ...
                                                                    <input class="form-control" type="text" id="tin_no" name="tin_no" placeholder="" data-validation="required">
                                                                </div>
                                                            </div>
                                                            <div class="col-md-3">
                                                                <div class="form-group">
                                                                    <label class="required">Tax Status</label> 
                                                                    <select id="tax_status" class="form-control m-input select2" name="tax_status" placeholder="Select an option" data-validation="required">
                                                                        <option value="">Select an Option</option>
                                                            ...
                                                            <div class="col-md-3">
                                                                <div class="form-group">
                                                                    ...
                                                                    <input class="form-control" type="text" id="phealth_no" name="phealth_no" placeholder="" data-validation="required">
                                                                </div>
                                                            </div>
                                                            <div class="col-md-3">
                                                                <div class="form-group">
                                                                    <label class="required">Pag-ibig #</label> 
                                                                    <input class="form-control" type="text" id="pagibig_no" name="pagibig_no" placeholder="" data-validation="required">
                                                                </div>
                                                            </div>
                                                        </div>
                                                        <div class="row">
                                                            ...
                                                            <div class="col-md-3">
                                                                <div class="form-group">
                                                                    ...
                                                                    <input class="form-control" type="text" name="sss_no" id="sss_no" placeholder="" data-validation="required">
                                                                </div>
                                                            </div>
                                                        </div>
                                                        <hr>
                                                        ...
                                                        <div class="row">
                                                            <div class="col-md-3">
                                                                <div class="form-group">
                                                                    ...
                                                                    <input class="form-control" type="text" name="fat_name" placeholder="" data-validation="required">
                                                                </div>
                                                            </div>
                                                            <div class="col-md-3">
                                                                <div class="form-group">
                                                                    <label class="required">Contact No.</label> 
                                                                    <input class="form-control" type="text" name="fat_contact" placeholder="" data-validation="required">
                                                                </div>
                                                            </div>
                                                            <div class="col-md-6">
                                                                <div class="form-group">
                                                                    <label class="required">Current Address</label> 
                                                                    <input class="form-control" type="text" name="fat_addr" placeholder="" data-validation="required">
                                                                </div>
                                                            </div>
                                                        </div>
                                                        <div class="row">
                                                            <div class="col-md-4">
                                                                <div class="form-group">
                                                                    ...
                                                                    <input class="form-control" type="text" name="fat_company" placeholder="" data-validation="required">
                                                                </div>
                                                            </div>
                                                            <div class="col-md-4">
                                                                <div class="form-group">
                                                                    <label class="required">Occupation</label> 
                                                                    <input class="form-control" type="text" name="fat_occupation" placeholder="" data-validation="required">
                                                                </div>
                                                            </div>
                                                        </div>
                                                        <div class="row">
                                                            <div class="col-md-1">
                                                                <div class="form-group">
                                                                    ...
                                                                    <span class="m-switch m-switch--sm">
                                                                        <label>
                                                                            <input type="checkbox" id="fat_deceased" name="fat_deceased" data-identifier="father_is_deceased" true-value="1" false-value="0"> 
                                                                            <span></span>
                                                                        </label>
                                                                    </span>
                                                                </div>
                                                        ...
                                                        <div class="row">
                                                            <div class="col-md-3">
                                                                <div class="form-group">
                                                                    <label class="required">Full Name</label> 
                                                                    <input class="form-control" type="text" name="mot_name" placeholder="" data-validation="required">
                                                                </div>
                                                            </div>
                                                            <div class="col-md-3">
                                                                <div class="form-group">
                                                                    <label class="required">Contact No.</label> 
                                                                    <input class="form-control" type="text" name="mot_contact" placeholder="" data-validation="required">
                                                                </div>
                                                            </div>
                                                            <div class="col-md-6">
                                                                <div class="form-group">
                                                                    <label class="required">Current Address</label> 
                                                                    <input class="form-control" type="text" name="mot_addr" placeholder="" data-validation="required">
                                                                </div>
                                                            </div>
                                                        </div>
                                                        <div class="row">
                                                            <div class="col-md-4">
                                                                <div class="form-group">
                                                                    <label class="required">Company</label> 
                                                                    <input class="form-control" type="text" name="mot_company" placeholder="" data-validation="required">
                                                                </div>
                                                            </div>
                                                            <div class="col-md-4">
                                                                <div class="form-group">
                                                                    <label class="required">Occupation</label> 
                                                                    <input class="form-control" type="text" name="mot_occupation" placeholder="" data-validation="required">
                                                                </div>
                                                            </div>
                                                        </div>
                                                        <div class="row">
                                                            <div class="col-md-1">
                                                                <div class="form-group">
                                                                    ...
                                                                    <span class="m-switch m-switch--sm">
                                                                        <label>
                                                                            <input type="checkbox" id="mot_deceased" name="mot_deceased" data-identifier="mother_is_deceased" true-value="1" false-value="0"> 
                                                                            <span></span>
                                                                        </label>
                                                                    </span>
                                                                </div>
                                                        ...
                                                        <div class="row mb-3">
                                                            <div class="col-md-6">
                                                                <div class="m-checkbox-inline">
                                                                    <label class="m-checkbox">
                                                                        <input id="pt_status" type="radio" name="partner_type" value="1" class="m--partner_switch" onclick="getStatus()">Married<span></span>
                                                                    </label> 
                                                                    <label class="m-checkbox">
                                                                        <input id="pt_status" type="radio" name="partner_type" value="2" class="m--partner_switch" onclick="getStatus()">Partner<span></span>
                                                                    </label> 
                                                                    <label class="m-checkbox">
                                                                        <input id="pt_status" type="radio" name="partner_type" value="3" class="m--partner_switch" onclick="getStatus()">Single<span></span>
                                                                    </label>
                                                                </div>
                                                            </div>
                                                        </div>
                                                        <div class="row">
                                                            <div class="col-md-3">
                                                                <div class="form-group">
                                                                    <label class="required">Full Name</label> 
                                                                    <input class="form-control m-input--partners_detail" type="text" name="partners_name" placeholder="" data-validation="required">
                                                                </div>
                                                            </div>
                                                            <div class="col-md-3">
                                                                <div class="form-group">
                                                                    <label class="required">Contact No.</label> 
                                                                    <input class="form-control m-input--partners_detail" type="text" name="partners_contact" placeholder="" data-validation="required">
                                                                </div>
                                                            </div>
                                                            <div class="col-md-6">
                                                                <div class="form-group">
                                                                    <label class="required">Current Address</label> 
                                                                    <input class="form-control m-input--partners_detail" type="text" name="partners_addr" placeholder="" data-validation="required">
                                                                </div>
                                                            </div>
                                                        </div>
                                                        <div class="row">
                                                            <div class="col-md-4">
                                                                <div class="form-group">
                                                                    <label class="required">Company</label> 
                                                                    <input class="form-control m-input--partners_detail" type="text" name="partners_company" placeholder="" data-validation="required">
                                                                </div>
                                                            </div>
                                                            <div class="col-md-4">
                                                                <div class="form-group">
                                                                    <label class="required">Occupation</label> 
                                                                    <input class="form-control m-input--partners_detail" type="text" name="partners_occupation" placeholder="" data-validation="required">
                                                                </div>
                                                            </div>
                                                        </div>
                                                        <div class="row">
                                                            <div class="col-md-1">
                                                                <div class="form-group">
                                                                    ...
                                                                    <span class="m-switch m-switch--sm">
                                                                        <label>
                                                                            <input type="checkbox" id="partner_deceased" name="partners_deceased" data-identifier="partner_is_deceased" true-value="1" false-value="0"> 
                                                                            <span></span>
                                                                        </label>
                                                                    </span>
                                                                </div>
                                        ...
                                        <div class="tab-pane" role="tabpanel" id="step3">
                                            <form id="others-data" role="form" class="form-group">
                                                <input type="hidden" name="csrf_token" value="<?php echo $this->security->get_csrf_hash(); ?>" autocomplete="off">
                                                <input type="hidden" name="personnel_request_id" id="personnel_request_id">
                                                <template v-if="count > 0">
                                                    <input type="hidden" id="emp_id" name="id" :value="row.id">
                                                ...
                                                <div class="m-portlet m-portlet--bordered m-portlet--bordered-semi m-portlet--rounded">
                                                    ...
                                                    <div class="m-portlet__body">
                                                        ...
                                                        <div class="row justify-content-end px-3">
                                                            ...
                                                            <button type="button" class="btn btn-success next-step" href="#step4">Next <i class="fa fa-arrow-right"></i></button>
                                                        </div>
                                                        <div class="row justify-content-end px-3">
                                                ...
                                                <div class="m-portlet__body">
                                                    <template v-if="count > 0">
                                                        <div class="personal-information">
                                                            ...
                                                            <div class="row">
                                                                <div class="col-md-3">
                                                                    ...
                                                                    <p>{{ strFormat(row.firstname) }}</p>
                                                                </div>
                                                                <div class="col-md-3">
                                                                    <label for="">Last Name</label>
                                                                    <p>{{ strFormat(row.lastname) }}</p>
                                                                </div>
                                                                <div class="col-md-3">
                                                                    <label for="">Middle Name</label>
                                                                    <p>{{ strFormat(row.middlename) ? strFormat(row.mname) : "---" }}</p>
                                                                </div>
                                                                <div class="col-md-3">
                                                                    <label for="">Suffix</label>
                                                                    <p>{{ strFormat(row.suffix) ? strFormat(row.suff) : "---" }}</p>
                                                                </div>
                                                            </div>
                                                            <div class="row">
                                                                <div class="col-md-3">
                                                        ...
                                                        <div class="row justify-content-end px-3">
                                                            ...
                                                            <button type="button" id="submit-employee" onclick="submitEmp()" class="btn btn-success final-btn">Submit</button>
                                                        </div>
                                                    </template>
                                                </div>
                                            </div>
...
<script>
    ...
    $(document).ready(function () {     
        ...
        $(".next-step").click(function (e) {
            ...
            if(submit_btn == 'btn-step1'){
                form = '#user-data';
                url = '<?php echo base_url("hris/employee_fillout/save_data"); ?>';
            }

            if(submit_btn == 'btn-step2'){
                form = '#additional-data';
                url = '<?php echo base_url("hris/employee_fillout/update_additional"); ?>'
            }
                ...
                $.validate({
                    ...
                    onSuccess: function(form){
                        ...
                        $.ajax({
                            ...
                            data: data,
                            beforeSend: function(){
                                $(form).find("button[type=submit]").addClass("m-btn--custom m-loader m-loader--light m-loader--right").prop("disabled", true);
                            },
                            success: function(response){
                                if(response.alert == 'success'){
                                    ...
                                    toastr.warning('Failed', response.message, 5000);
                                }

                                $(form).find("button[type=submit]").removeClass("m-btn--custom m-loader m-loader--light m-loader--right").prop("disabled", false);
                            }
                        });
        ...
        .on('click', '.btnEditDependents', function () {
            ...
            $.ajax({
                url: '<?=base_url("hris/employee_fillout/open_edit_modal") ?>',
                type: "POST",
                dataType: "JSON",
                data: {
                    csrf_token: _csrf_hash,
                    path: "hris/employee_fillout/modals/edit_dependent",
                    function_name: "getDependentInfo",
                    model: "externalForm_model",
                    formData: {id}
                },
                success: function (response) {
        ...
        .on('click', '.btnRemoveDependents', function () {
            const id = $(this).attr('data-id');
            $.ajax({
                url: '<?=base_url("hris/employee_fillout/open_confirm_modal") ?>',
                type: "POST",
                data: {
                    csrf_token: _csrf_hash,
                    formData: {
                        ...
                        action: "hris/employee_fillout/remove_dependent/" + id,
                        color: "btn-danger"
                    },
        ...
        .on('click', '.btnEditEducational', function () {
            ...
            $.ajax({
                ...
                data: {
                    csrf_token: _csrf_hash,
                    path: "hris/employee_fillout/modals/edit_educational_background",
            ...
            $.ajax({
                ...
                data: {
                    ...
                    formData: {
                        title: "<i class='la la-trash mr-2'></i>Confirm Remove",
                        message: "Are you sure to remove this record?",
                        action: "hris/employee_fillout/remove_educational_background/" + id,
                        color: "btn-danger"
                    },
                    path: "ams/confirmation_dialog",
                    function_name: "passDataToDialog"
        ...
        .on('click', '.btnEditLicensure', function () {
            ...
            $.ajax({
                ...
                data: {
                    csrf_token: _csrf_hash,
                    path: "hris/employee_fillout/modals/edit_licensure",
            ...
            $.ajax({
                ...
                data: {
                    ...
                    formData: {
                        title: "<i class='la la-trash mr-2'></i>Confirm Remove",
                        message: "Are you sure to remove this record?",
                        action: "hris/employee_fillout/remove_licensure/" + id,
                        color: "btn-danger"
                    },
                    path: "ams/confirmation_dialog",
                    function_name: "passDataToDialog"
        ...
        .on('click', '.btnEditDriverLicense', function () {
            ...
            $.ajax({
                ...
                data: {
                    csrf_token: _csrf_hash,
                    path: "hris/employee_fillout/modals/edit_driverlicense",
            ...
            $.ajax({
                ...
                data: {
                    ...
                    formData: {
                        title: "<i class='la la-trash mr-2'></i>Confirm Remove",
                        message: "Are you sure to remove this record?",
                        action: "hris/employee_fillout/remove_driverlicense/" + id,
                        color: "btn-danger"
                    },
                    path: "ams/confirmation_dialog",
                    function_name: "passDataToDialog"
        ...
        .on('click', '.btnEditWorkExperience', function () {
            ...
            $.ajax({
                ...
                data: {
                    csrf_token: _csrf_hash,
                    path: "hris/employee_fillout/modals/edit_work_experience",
            ...
            $.ajax({
                ...
                data: {
                    ...
                    formData: {
                        title: "<i class='la la-trash mr-2'></i>Confirm Remove",
                        message: "Are you sure to remove this record?",
                        action: "hris/employee_fillout/remove_worK_experience/" + id,
                        color: "btn-danger"
                    },
                    path: "ams/confirmation_dialog",
                    function_name: "passDataToDialog"
        ...
        .on('click', '.btnEditAwards', function () {
            ...
            $.ajax({
                ...
                data: {
                    csrf_token: _csrf_hash,
                    path: "hris/employee_fillout/modals/edit_award",
            ...
            $.ajax({
                ...
                data: {
                    ...
                    formData: {
                        title: "<i class='la la-trash mr-2'></i>Confirm Remove",
                        message: "Are you sure to remove this record?",
                        action: "hris/employee_fillout/remove_award/" + id,
                        color: "btn-danger"
                    },
                    path: "ams/confirmation_dialog",
                    function_name: "passDataToDialog"
        ...
        .on('click', '.btnEditOrganization', function () {
            ...
            $.ajax({
                ...
                data: {
                    csrf_token: _csrf_hash,
                    path: "hris/employee_fillout/modals/edit_organization",
            ...
            $.ajax({
                ...
                data: {
                    ...
                    formData: {
                        title: "<i class='la la-trash mr-2'></i>Confirm Remove",
                        message: "Are you sure to remove this record?",
                        action: "hris/employee_fillout/remove_organization/" + id,
                        color: "btn-danger"
                    },
                    path: "ams/confirmation_dialog",
                    function_name: "passDataToDialog"
        ...
        .on('click', '.btnEditTrainings', function () {
            ...
            $.ajax({
                ...
                data: {
                    csrf_token: _csrf_hash,
                    path: "hris/employee_fillout/modals/edit_training",
            ...
            $.ajax({
                ...
                data: {
                    ...
                    formData: {
                        title: "<i class='la la-trash mr-2'></i>Confirm Remove",
                        message: "Are you sure to remove this record?",
                        action: "hris/employee_fillout/remove_training/" + id,
                        color: "btn-danger"
                    },
                    path: "ams/confirmation_dialog",
                    function_name: "passDataToDialog"
        ...
        .on('click', '.btnEditPersonalReference', function () {
            ...
            $.ajax({
                ...
                data: {
                    csrf_token: _csrf_hash,
                    path: "hris/employee_fillout/modals/edit_personal_references",
            ...
            $.ajax({
                ...
                data: {
                    ...
                    formData: {
                        title: "<i class='la la-trash mr-2'></i>Confirm Remove",
                        message: "Are you sure to remove this record?",
                        action: "hris/employee_fillout/remove_personal_reference/" + id,
                        color: "btn-danger"
                    },
                    path: "ams/confirmation_dialog",
                    function_name: "passDataToDialog"
        ...
        .on('click', '.btnEditMedicalHistory', function () {
            ...
            $.ajax({
                ...
                data: {
                    csrf_token: _csrf_hash,
                    path: "hris/employee_fillout/modals/edit_medical_history",
            ...
            $.ajax({
                ...
                data: {
                    ...
                    formData: {
                        title: "<i class='la la-trash mr-2'></i>Confirm Remove",
                        message: "Are you sure to remove this record?",
                        action: "hris/employee_fillout/remove_medical_record/" + id,
                        color: "btn-danger"
                    },
                    path: "ams/confirmation_dialog",
                    function_name: "passDataToDialog"
        ...
        .on('click', '.btnEditSkill', function () {
            ...
            $.ajax({
                ...
                data: {
                    csrf_token: _csrf_hash,
                    path: "hris/employee_fillout/modals/edit_skill",
            ...
            $.ajax({
                ...
                data: {
                    ...
                    formData: {
                        title: "<i class='la la-trash mr-2'></i>Confirm Remove",
                        message: "Are you sure to remove this record?",
                        action: "hris/employee_fillout/remove_skill/" + id,
                        color: "btn-danger"
                    },
                    path: "ams/confirmation_dialog",
                    function_name: "passDataToDialog"
    ...
    var updateUmidTypeSwitch = function () {
        var _formAdditionalInformation = $("form#additional-data");
    ...
    function applicantData($id = 0){
        var emp_id = (typeof $("#emp_id").val() !== 'undefined') ? $("#emp_id").val() : $id;
        $.ajax({
            url: "<?php echo base_url("hris/employee_fillout/get_data"); ?>",
            dataType: "JSON",
            type: "GET",
            data: {
                emp_id: emp_id
            ...
            success: function(response){
                if(response.data){
                    var data = response;
                    vmData.row = data.data;
                    vmData.count = data.count;
                    vmData.tempId = data.data.id;
                    tempDataId = data.data.id;

                    if(data.data.civil_stat == 'Single'){
                        $("input[value=3]").prop('checked', true);
                        $(".m-input--partners_detail").prop('disabled', true).prop('data-validation', false);
                    }

                    if(data.data.civil_stat == 'Married'){
                        $("input[value=1]").prop('checked', true);
                        $(".m-input--partners_detail").prop('disabled', false).prop('data-validation', true);
                    }
                }
            }
        });
    ...
    var dtDependents = function(id = null) {
        $.ajax({
            url: '<?=base_url("hris/employee_fillout/get_employee_dependents") ?>',
            type: "post",
            dataType: "json",
            data : {
                csrf_token : _csrf_hash,
    ...
    $(document).on("click", ".btnDependents", function () {
        $.ajax({
            url: '<?=base_url('hris/employee_fillout/get_modal/') ?>' + tempDataId + '/' + 'dependents',
            dataType: "json",
            success: function (json) {
    ...
    var dtEducation = function(id = null){
        $.ajax({
            url: '<?=base_url("hris/employee_fillout/get_employee_educational_bg") ?>',
            type: "post",
            dataType: "json",
            data : {
                csrf_token : _csrf_hash,
    ...
    $(document).on('click', '.btnAddEducation', function(){
        $.ajax({
            url: '<?=base_url('hris/employee_fillout/get_modal/') ?>' + tempDataId + '/' + 'education',
            dataType: "json",
            success: function (json) {
                var modalContent = modalTempContent.find(".modal-content");
                if (typeof modalContent !== "undefined" && typeof json.html !== "undefined") {
    ...
    var dtLicense = function(id = null) {
        $.ajax({
            url: '<?=base_url("hris/employee_fillout/get_employee_licensure") ?>',
            type: "post",
            dataType: "json",
            data : {
                csrf_token : _csrf_hash,
    ...
    $(document).on("click", ".btnAddLicense", function () {
        $.ajax({
            url: '<?=base_url('hris/employee_fillout/get_modal/') ?>' + tempDataId + '/' + 'licensure',
            dataType: "json",
            success: function (json) {
                var modalContent = modalTempContent.find(".modal-content");
                if (typeof modalContent !== "undefined" && typeof json.html !== "undefined") {
    ...
    var dtDrivers = function(id = null){
        $.ajax({
            url: '<?=base_url("hris/employee_fillout/get_employee_driverlicense") ?>',
            type: "post",
            dataType: "json",
            data : {
                csrf_token : _csrf_hash,
    ...
    $(document).on("click", ".btnAddDL", function () {
        $.ajax({
            url: '<?=base_url('hris/employee_fillout/get_modal/') ?>' + tempDataId + '/' + 'driverlicense',
            dataType: "json",
            success: function (json) {
                var modalContent = modalTempContent.find(".modal-content");
                if (typeof modalContent !== "undefined" && typeof json.html !== "undefined") {
    ...
    var dtWork = function(id = null){
        $.ajax({
            url: '<?=base_url("hris/employee_fillout/get_employee_work_experience") ?>',
            type: "post",
            dataType: "json",
            data : {
                csrf_token : _csrf_hash,
    ...
    $(document).on("click", ".btnAddWork", function () {
        $.ajax({
            url: '<?=base_url('hris/employee_fillout/get_modal/') ?>' + tempDataId + '/' + 'work_experience',
            dataType: "json",
            success: function (json) {
                var modalContent = modalTempContent.find(".modal-content");
                if (typeof modalContent !== "undefined" && typeof json.html !== "undefined") {
    ...
    var dtAwards = function(id = null){
        $.ajax({
            url: '<?=base_url("hris/employee_fillout/get_employee_awards") ?>',
            type: "post",
            dataType: "json",
            data : {
                csrf_token : _csrf_hash,
    ...
    $(document).on("click", ".btnAddAward", function () {
        $.ajax({
            url: '<?=base_url('hris/employee_fillout/get_modal/') ?>' + tempDataId + '/' + 'awards',
            dataType: "json",
            success: function (json) {
                var modalContent = modalTempContent.find(".modal-content");
                if (typeof modalContent !== "undefined" && typeof json.html !== "undefined") {
    ...
    var dtOrg = function(id = null){
        $.ajax({
            url: '<?=base_url("hris/employee_fillout/get_employee_organization") ?>',
            type: "post",
            dataType: "json",
            data : {
                csrf_token : _csrf_hash,
    ...
    $(document).on("click", ".btnAddOrg", function () {
        $.ajax({
            url: '<?=base_url('hris/employee_fillout/get_modal/') ?>' + tempDataId + '/' + 'organization',
            dataType: "json",
            success: function (json) {
                var modalContent = modalTempContent.find(".modal-content");
                if (typeof modalContent !== "undefined" && typeof json.html !== "undefined") {
    ...
    var dtTraining = function(id = null){
        $.ajax({
            url: '<?=base_url("hris/employee_fillout/get_employee_training") ?>',
            type: "post",
            dataType: "json",
            data : {
                csrf_token : _csrf_hash,
    ...
    $(document).on("click", ".btnAddTraining", function () {
        $.ajax({
            url: '<?=base_url('hris/employee_fillout/get_modal/') ?>' + tempDataId + '/' + 'training',
            dataType: "json",
            success: function (json) {
                var modalContent = modalTempContent.find(".modal-content");
                if (typeof modalContent !== "undefined" && typeof json.html !== "undefined") {
    ...
    var dtPersonal = function(id = null){
        $.ajax({
            url: '<?=base_url("hris/employee_fillout/get_employee_personal_reference") ?>',
            type: "post",
            dataType: "json",
            data : {
                csrf_token : _csrf_hash,
    ...
    $(document).on("click", ".btnAddPersonal", function () {
        $.ajax({
            url: '<?=base_url('hris/employee_fillout/get_modal/') ?>' + tempDataId + '/' + 'personal_references',
            dataType: "json",
            success: function (json) {
                var modalContent = modalTempContent.find(".modal-content");
                if (typeof modalContent !== "undefined" && typeof json.html !== "undefined") {
    ...
    var dtMedical = function(id = null){
        $.ajax({
            url: '<?=base_url("hris/employee_fillout/get_employee_medical_history") ?>',
            type: "post",
            dataType: "json",
            data : {
                csrf_token : _csrf_hash,
    ...
    $(document).on("click", ".btnAddMedical", function () {
        $.ajax({
            url: '<?=base_url('hris/employee_fillout/get_modal/') ?>' + tempDataId + '/' + 'medical_history',
            dataType: "json",
            success: function (json) {
                var modalContent = modalTempContent.find(".modal-content");
                if (typeof modalContent !== "undefined" && typeof json.html !== "undefined") {
    ...
    var dtSkill = function(id = null){
        $.ajax({
            url: '<?=base_url("hris/employee_fillout/get_employee_skills") ?>',
            type: "post",
            dataType: "json",
            data : {
                csrf_token : _csrf_hash,
    ...
    $(document).on('click', '.btnAddSkills', function() {
        $.ajax({
            url: '<?=base_url('hris/employee_fillout/get_modal/') ?>' + tempDataId + '/' + 'skill',
            dataType: "json",
            success: function(json){
                var modalContent = modalTempContent.find(".modal-content");
                if (typeof modalContent !== "undefined" && typeof json.html !== "undefined") {
    ...
    function getStatus(){
        var partner = $("#pt_status:checked").val();

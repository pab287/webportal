...
<form id="form-medical_history" method="post" action="<?php echo site_url("hris/employee_fillout/set_modal_medical_history"); ?>">
...
<div class="modal-body">
    ...
    <div class="form-group">
		...
		<textarea id="med_remarks" name="remarks" rows="7" autocomplete="off" class="form-control m-input" style="min-height: 120px; resize: vertical;"></textarea>
    </div>
</div>

...
<form id="form_category" method="post" action="<?php echo site_url("ticket/ticket/update_modal_category"); ?>">
    ...
    <div class="modal-body" id="archive_text">
        <div class="form-group">
            ...
            <input id="name" name="name" type="text" autocomplete="off"
                    data-validation="required" class="form-control m-input" value="<?= $data->name ?>"/>
        </div>

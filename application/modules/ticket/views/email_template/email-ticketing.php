                            ...
                            <table border="0" align="center" width="980" cellpadding="0" cellspacing="0" class="container980">
								<tr>
                                    ...
                                    <h1 align="center">Ticketing System</h1>
										<h4 align="center" style="margin-top: 15px;"><?php if($module){ echo strtoupper($type)."<br> (".strtoupper($module).")"; }else{ echo strtoupper($type); }?></h4>
									</td>
                                </tr>
                            </table>
                        </td>
                    ...
                    <tbody>
                        ...
                        <?php if($status == "Open"){ ?>
                            <tr>
                                ...
                                <div style="line-height: 24px">A new <strong><?php echo strtoupper($type);?></strong> request has been created for <b><?php echo strtoupper($module); ?></b> module on the Ticketing system that needs your attention today, <?php echo ($date)? date("F d, Y", strtotime($date)): date("F d, Y"); ?>. The details are as follows:  </div> 
                                </td>
                            </tr>
                            <tr>
                        ...
                        <?php }else{ ?>
                            <tr>
                                <td align="left" style="color: #888888; font-size: 16px; font-family: 'Work Sans', Calibri, sans-serif; line-height: 24px;">
                                <div style="line-height: 24px">Your Ticket # <?= $reference_no ?> is <strong><?= strtoupper($status); ?>.</strong>
                                </td>
                            </tr>   
                            <tr>
                                <td height="10" style="font-size: 10px; line-height: 10px;">&nbsp;</td>
                        ...
                        <?php if($status == 'Open'){ ?>
                            <tr>
                                <td align="left" style="color: #888888; font-size: 16px; font-family: 'Work Sans', Calibri, sans-serif; line-height: 24px;">
                                <div style="line-height: 24px">Reference: <?php echo $reference_no; ?> </div> 
                                </td>
                            </tr>
                            <tr>
                                <td align="left" style="color: #888888; font-size: 16px; font-family: 'Work Sans', Calibri, sans-serif; line-height: 24px;">
                        ...
                        <tr>
							<td align="left" style="color: #888888; font-size: 16px; font-family: 'Work Sans', Calibri, sans-serif; line-height: 24px;">
                            <div style="line-height: 24px">Requested by: <?php $name = $this->ticket->requested_by($employee_name); echo $name; ?> </div> 
							</td>
						</tr>
                        <?php } ?>
                        <tr>
                        ...
                        <tr>
							<td align="left" style="color: #888888; font-size: 16px; font-family: 'Work Sans', Calibri, sans-serif; line-height: 24px;">
                            <div style="line-height: 24px">Date Requested: <?php echo $need_dt ?> </div> 
							</td>
						</tr>
                        <tr>
                            <td height="10" style="font-size: 10px; line-height: 10px;">&nbsp;</td>
                        ...
                        <tr>
							<td align="left" style="color: #888888; font-size: 16px; font-family: 'Work Sans', Calibri, sans-serif; line-height: 24px;">
                            <div style="line-height: 24px">Kindly acknowledge this request. <br>Reminder: Please Login to Ticketing to Use Link <a href="<?php echo site_url("ticket/tickets/view_ticket?id=").$id?>">Click to Proceed to the Request.</a> Thank you!</div> 
							</td>
						</tr>
                    </tbody>
                </table>

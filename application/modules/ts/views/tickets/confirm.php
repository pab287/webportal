    ...
    <div class="row">
        <div class="col-lg-12">
            <div class="m-portlet m-portlet--mobile">
                ...
                <form id="frm_status_confirm_ticket" onsubmit="confirmService(this)">
                    ...
                    <div class="m-portlet__body">
                        <div class="row">
                            <div class="col-md-6">
                                <div class="form-group m-form__group row">
                                    ...
                                    <div class="col-10">
                                        <select id="department" name="department" data-validation="required" disabled>
                                ...
                                <div class="form-group m-form__group row">
                                    ...
                                    <div class="col-10 input-group date" id="need_dt">
                                        <input class="form-control m-input" type="text" name="need_dt" id="need_dt"
                                               maxlength="22"
                                               v-model="moment(vm_tab1.need_dt).format('YYYY/MM/DD')"
                                ...
                                <div class="form-group m-form__group row">
                                    ...
                                    <div class="col-10">
                                        <textarea class="form-control m-input" id="issue" name="issue" rows="4"
                                                  ...
                                                  data-validation="required" disabled></textarea>
                                    </div>
                                </div>
                                <br>
                            </div>
                        ...
                        <div class='row'>
                            <div class='col-md-6'>
                                <div class="form-group m-form__group row">
                                    ...
                                    <div class="col-10">
                                        <input class="form-control m-input" type="text" name="performed_by"
                                               v-model="vm_tab1.emp_name"
                                               data-validation="required" disabled/>
                                    </div>
                                </div>
                                <div class="form-group m-form__group row">
                                    ...
                                    <div class="col-10">
                                        <input class="form-control m-input" type="text" name="performed_dt"
                                               v-model="moment(vm_tab1.performed_dt).format('YYYY/MM/DD')"
                                               data-validation="required" disabled/>
                                    </div>
                                </div>
                                <div class="form-group m-form__group row">
                                    ...
                                    <div class="col-10">
                                        <textarea class="form-control m-input" id="remarks" name="remarks"
                                                  v-model="vm_tab1.remark" rows="4"
                                                  data-validation="required" disabled></textarea>
                                    </div>
                                </div>
                            </div>
                            <div class='col-md-6'>
                                <div class="form-group m-form__group row">
                                    ...
                                    <div class="col-10">
                                        <textarea class="form-control m-input" id="reason" name="reason"
                                                  v-model="vm_tab1.open" rows="4"></textarea>
                                    </div>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="col-xl-12 order-1 order-xl-2 m--align-right">
                            <button type="button" id="reopen"
                                    class="btn text-white btn-warning m-btn m-btn--custom m-btn--icon m-btn--air m-btn--box btn-submit btnNew">
                                <span>
                                        Reopen            
                                </span>
                            </button>

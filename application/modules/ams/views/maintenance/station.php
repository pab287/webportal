            ...
            <div class="m-portlet m-portlet--mobile">
                ...
                <div class="m-portlet__body">
                    ...
                    <div class="m_datatable m-datatable m-datatable--default m-datatable--loaded m-datatable--scroll">
                        <table class="table table-striped table-bordered" id="table-station" width="100%">
                            <thead>
                            <tr>
                                <th>Station</th>
                                <th>Action</th>
                        ...
                        <div class="modal-dialog">
                            <div class="modal-content">
                                ...
                                <div class="modal-footer">
                                    <button type="button" onclick="delete_station()"
                ...
                <div class="modal fade" id="modal_form_station" role="dialog">
                    <div class="modal-dialog">
                        <div class="modal-content">
                            <div class="modal-header">
                                <h3 class="modal-title"></h3>
                            ...
                            <div class="modal-body form">
                                <form action="#" id="form_station" class="form-horizontal">
                            ...
                            <div class="modal-footer">
                                ...
                                <button type="submit" id="btnSave" onclick="save_station()"

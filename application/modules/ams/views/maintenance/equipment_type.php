            ...
            <div class="m-portlet m-portlet--mobile">
                ...
                <div class="m-portlet__body">
                                    ...
                                    <div style='float:right !important;' class="form-group m-form__group row">
                                        <div class="col-md-4">
                                            <div class="m-input-icon m-input-icon--left">
                                                <button class="btn btn-secondary dropdown-toggle" aria-expanded="true">
                                                    <i class="la la-table"></i></button>
                                            </div>
                                        </div>
                                        <div class="col-md-4">
                                            <div class="m-input-icon m-input-icon--left">
                                                <button class="btn btn-secondary dropdown-toggle" aria-expanded="true">
                                                    <i class="la la-external-link"></i></button>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="colms-12">
                    ...
                    <div class="m_datatable m-datatable m-datatable--default m-datatable--loaded m-datatable--scroll">
                        <table class="table table-striped table-bordered" id="table-equipment_type" width="100%">
                            <thead>
                            <tr>
                        ...
                        <div class="modal-dialog">
                            <div class="modal-content">
                                ...
                                <div class="modal-footer">
                                    <button type="button" onclick="delete_equipment_type()"
                                            class="btn btn-primary m-btn m-btn--custom m-btn--icon  btnNew">Delete
                                    </button>
                                    <button type="button"
                                            class="btn btn-danger m-btn m-btn--custom m-btn--icon  btnNew"
                ...
                <div class="modal fade" id="modal_form_equipment_type" role="dialog">
                    <div class="modal-dialog">
                        <div class="modal-content">
                            <div class="modal-header">
                                <h3 class="modal-title"></h3>
                            ...
                            <div class="modal-body form">
                                <form action="#" id="form_equipment_type" class="form-horizontal">
                                    <input type="hidden" value="" name="id"/>
                                    <input type="hidden" name="csrf_token"
                                           value="<?php echo $this->security->get_csrf_hash(); ?>">

                                    <div class="form-group">
                                        <label class="control-label col-md-2">Equipment Category</label>
                                        <div class="col-md-12">
                                            <select id="select2_category" name="ec_id" data-validation="required">
                                            </select>
                                        </div>
                                    </div>
                            ...
                            <div class="modal-footer">
                                ...
                                <button type="submit" id="btnSave" onclick="save_equipment_type()"

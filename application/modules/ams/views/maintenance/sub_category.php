            ...
            <div class="m-portlet m-portlet--mobile">
                ...
                <div class="m-portlet__body">
                    ...
                    <div class="m_datatable m-datatable m-datatable--default m-datatable--loaded m-datatable--scroll table-responsive">
                        <table class="table table-striped table-bordered" id="table-sub_category" width="100%">
                            <thead>
                            <tr>
                                <th>main category</th>
                        ...
                        <div class="modal-dialog">
                            <div class="modal-content">
                                ...
                                <div class="modal-footer">
                                    <button type="button" onclick="delete_sub_category()"
                ...
                <div class="modal fade" id="modal_form_sub_category" role="dialog">
                    <div class="modal-dialog">
                        <div class="modal-content">
                            <div class="modal-header">
                                <h3 class="modal-title"></h3>
                            ...
                            <div class="modal-body form">
                                <form action="#" id="form_sub_category" class="form-horizontal">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-md-12">
                                            <select id="select2_category" name="cat_id" data-validation="required">
                            ...
                            <div class="modal-footer">
                                ...
                                <button type="submit" id="btnSave" onclick="save_sub_category()"

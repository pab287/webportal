                    ...
                    <div class="m-portlet__head-caption">
                        <div class="m-portlet__head-title">
                            <span class="m-portlet__head-icon">
                                ...
                                <a type="button" href="<?php echo site_url("ams/assets/asset_components_masterfile"); ?>"
                                   data-original-title="Go to Masterfile"
                            ...
                            <form id="frm-edit-fixed-asset">
                                ...
                                <div class="row">
                                    <div class="col-xl-3 col-lg-3 col-md-4 col-sm-12">
                                        <div class="form-group m-form__group">
                                            ...
                                            <input type="text" class="form-control m-input input-auto-height"
                                                ...
                                                value="<?= $rs->brand ?>" id="update_comp_asset_brand" onkeyup="edit_generate_asset_comp_name()">
                                        </div>
                                    </div>
                                    <div class="col-xl-3 col-lg-3 col-md-4 col-sm-12">
                                        <div class="form-group m-form__group">
                                            ...
                                            <input type="text" class="form-control m-input input-auto-height"
                                                ...
                                                data-validation="required"
                                                value="<?= $rs->modelno ?>" id="update_comp_asset_model" onkeyup="edit_generate_asset_comp_name()">
                                        </div>
                                    </div>
                                    <div class="col-xl-6 col-lg-6 col-md-6 col-sm-12">
                                        <div class="form-group m-form__group">
                                            ...
                                            <input type="text" class="form-control m-input input-auto-height"
                                                name="name" data-validation="required" autocomplete="off" value="<?= $rs->name ?>" id="update_comp_asset_name">
                                        </div>
                                    </div>
                                ...
                                <div class="mt-5 row">
                                    <div class="form-group m-form__group col-xl-3 col-lg-3 col-md-3 col-sm-12">
                                        <label style="text-transform: uppercase;" for="">Created By</label>
                                        <input type="text" class="form-control" disabled value="<?= $rs->createdBy ?>">
                                    </div>
                                    <div class="form-group m-form__group col-xl-3 col-lg-3 col-md-3 col-sm-12">
                                        <label style="text-transform: uppercase;" for="">Created At</label>
                                        <input type="text" class="form-control" disabled
                                            value="<?= date('Y-m-d, h:i:s a', strtotime($rs->dateCreated)) ?>">
                                    </div>
                                    <div class="form-group m-form__group col-xl-3 col-lg-3 col-md-3 col-sm-12">
                                        <label style="text-transform: uppercase;" for="">Updated By</label>
                                        <input type="text" class="form-control" disabled value="<?= $rs->updatedBy ?>">
                                    </div>
                                    <div class="form-group m-form__group col-xl-3 col-lg-3 col-md-3 col-sm-12">
                                        <label style="text-transform: uppercase;" for="">Updated At</label>
                                        <input type="text" class="form-control" disabled
                                ...
                                <div class="mt-5 row">
                                    <div class="form-group m-form__group col-xl-3 col-lg-3 col-md-3 col-sm-12">
                                        <label style="text-transform: uppercase;" for="">Inventory By</label>
                                        <input type="text" class="form-control" id="inv_checked_by" disabled value="<?= $rs->checked_by ?>">
                                    </div>
                                    <div class="form-group m-form__group col-xl-3 col-lg-3 col-md-3 col-sm-12">
                                        <label style="text-transform: uppercase;" for="">Inventory Date</label>
                                ...
                                <div class="mt-5 flex-row justify-content-end">
                                    <div class="d-flex justify-content-end">
                                        <button type="button" class="btn btn-lg btn-success m-btn btnUpdate mr-2" data-toggle="modal"
                        ...
                        <ul class="m-portlet__nav">
                            <li class="m-portlet__nav-item">
                                ...
                                <button type="button"
                                        ...
                                        data-toggle="m-tooltip"
                                        data-original-title="Click to add images"
                                        data-delay='{"show": 300}'
                                        data-skin="dark"
                            ...
                            <div class="d-flex flex-column images-preview-container__wrapper isUploaded">
                                ...
                                <div class="images-preview-container__image__actions d-flex">
                                    <button title="Set as Primary" type="button"
                                            ...
                                            data-toggle="m-tooltip"
                                            data-original-title="Set as Primary"
                                            data-delay='{"show": 300}'
                                            data-skin="dark">
...
<div class="modal fade" modal-exempt-custom data-backdrop="static" id="confirm-update-fix-asset">
...
<div class="modal fade" id="alert-dialog" modal-exempt-custom data-backdrop="static" role="dialog">
    <div class="modal-dialog" role="dialog">
        <div class="modal-content">
            <div class="modal-header">
...
<div class="modal fade" id="fail-upload-alert-dialog" modal-exempt-custom data-backdrop="static" role="dialog">
    <div class="modal-dialog" role="dialog">
        <div class="modal-content">
            <div class="modal-body">

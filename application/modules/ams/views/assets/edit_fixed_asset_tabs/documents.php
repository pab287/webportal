        ...
        <div class="row">
            <div class="col-md-12">
                    ...
                    <div class="row align-items-center">
                        <div class="col-xl-3">
                            <div class="m-input-icon m-input-icon--left">
                                <input type="text" class="form-control m-input" placeholder="Search" id="search-asset-document">
                ...
                <div class="m_datatable m-datatable m-datatable--default m-datatable--loaded m-datatable--scroll">
                    <table class="table table-striped table-bordered" id="table-asset-documents" width="100%">
                        <thead>
                        <th>Description</th>
                        <th>Filename</th>
                        <th>Action</th>
...
<div class="modal fade" id="mdl-delete-document-confirmation" tabindex="-1" role="dialog">
    <form id="frm-delete-document">

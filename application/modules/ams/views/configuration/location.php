    ...
    <div class="m-portlet">
        ...
        <div class="m-portlet__body">
            <div class="row">
                <div class="col-xl-6 col-lg-6 col-md-6">
                    <button class="btn btn-accent m-btn m-btn--pill btnNew"
                            onclick="open_new_location_dialog()">
                        ...
                        <div class="m-input-icon m-input-icon--left">
                            ...
                            <div class="input-group">
                                <input type="search" class="form-control"
                                       ...
                                       style="height: auto;" id="search-location">
            ...
            <div class="m_datatable m-datatable m-datatable--default m-datatable--loaded m-datatable--scroll m--margin-top-25">
                <table class="table table-striped table-bordered" id="table-asset-config-location" width="100%">
                    <thead>
                    <th>LOCATION</th>
                    <th>ACTION</th>
                    </thead>

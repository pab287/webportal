                            ...
                            <table border="0" align="center" width="980" cellpadding="0" cellspacing="0" class="container980">
								<tr>
                                    <td align="center" height="70" style="color: #343434; font-family: Quicksand, Calibri, sans-serif; font-weight:700;letter-spacing: 0px; text-align: center;">
										...
										<h4 align="center" style="margin-top: 15px;">AMS - NEWLY ADDED ASSET(S)</h4>
                    ...
                    <tbody>
						...
						<tr>
							<td align="left" style="color: #888888; font-size: 16px; font-family: 'Work Sans', Calibri, sans-serif; line-height: 24px;">
								<div style="line-height: 24px">These asset/s were added on <?= date("F d, Y")?>.</div>
							</td>
						</tr>
						<tr>
                ...
                <table align="center" border="0" width="980" cellpadding="0" cellspacing="0" bgcolor="ffffff">
                    ...
                    <thead>
                        ...
                        <tr>
                            ...
                            <th align="left" style="color: #343434; font-size: 14px; font-family: Quicksand, Calibri, sans-serif; font-weight:700;letter-spacing: 0px; line-height: 35px; margin-bottom: 10px;">DATE ADDED</th>
                            ...
                            <th align="left" style="color: #343434; font-size: 14px; font-family: Quicksand, Calibri, sans-serif; font-weight:700;letter-spacing: 0px; line-height: 35px; margin-bottom: 10px;">TYPE</th>
                        </tr>
                   </thead>
                   <tbody>
                        ...
                        <tr>
                            <td align="left" width="200" v-align="top" style="vertical-align: text-top; color: #343434; font-size: 14px; font-family: 
                                'Work Sans', Calibri, sans-serif; line-height: 18px; font-weight: 500;">
                                <?php echo $value->asset_code; ?>
                            </td>    
                            <td align="left" width="200" v-align="top" style="vertical-align: text-top; color: #343434; font-size: 14px; font-family: 
                                'Work Sans', Calibri, sans-serif; line-height: 18px; font-weight: 500;">
                                <?php echo $value->asset_name; ?>
                            </td>   
                            <td align="left" width="200" v-align="top" style="vertical-align: text-top; color: #343434; font-size: 14px; font-family: 
                                'Work Sans', Calibri, sans-serif; line-height: 18px; font-weight: 500;">
                                <?php echo $value->added_at; ?>
                            </td>   
                            <td align="left" width="200" v-align="top" style="vertical-align: text-top; color: #343434; font-size: 14px; font-family: 
                                'Work Sans', Calibri, sans-serif; line-height: 18px; font-weight: 500;">

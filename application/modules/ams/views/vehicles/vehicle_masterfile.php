            ...
            <div class="m-portlet m-portlet--mobile">
                <div class="m-portlet__head">
                    ...
                    <div class="m-portlet__head-tools">
                        <a href="<?= base_url('ams/vehicles/archive/?type=mother') ?>" class="custom-btn-link">
                        ...
                        <div class="row align-items-center">
                            <div class="col-xl-8 order-2 order-xl-1">
                                <div class="form-group m-form__group row align-items-center">
                                    <div class="col-md-12">
                                        <a href="<?php echo site_url("ams/vehicles/new_vehicle"); ?>"
                                        ...
                                        <button class="btn btn-primary m-btn m-btn--icon m-btn--pill btnAdvance_search" type="button" id="dropdownMenuButton" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                                            <span><i class="fa fa-search"></i><span>Search</span><span class="dropdown-toggle"></span></span>
                                        </button>
                                        <div class="dropdown-menu" aria-labelledby="dropdownMenuButton" x-placement="bottom-start" style="position: absolute; transform: translate3d(0px, 37px, 0px); top: 0px; left: 0px; will-change: transform;">
                                            <a class="dropdown-item" href="#" data-toggle="modal" data-target="#modal-accountability-search">
                                        ...
                                        <div class="dropdown d-inline">
                                            <button class="btn btn-brand m-btn m-btn--icon m-btn--pill mb-1 btnNew"
                            ...
                            <div class="col-xl-4 order-1 order-xl-2 m--align-right d-flex flex-row">
                                    ...
                                    <span class="m-input-icon__icon m-input-icon__icon--left" style="z-index: 5;">
                                        ...
                                        <div class="input-group">
                                            ...
                                            <button class="btn btn-secondary"
                                                    ...
                                                    data-delay='{"show": 300}' data-placement="bottom" data-skin="dark"
                                                    onclick="clearSearch()">
                                ...
                                <div class="btn-group ml-3" role="group"
                                    ...
                                    <div class="btn-group" role="group">
                                        ...
                                        <ul class="dropdown-menu dropdown-menu-right"
                                            ...
                                            <li class="dropdown-item pt-1 pb-1">
                                                <label class="m-checkbox mb-0">
                                                    <input type="checkbox" checked="checked"
                                                           oninput="showOrHideColumn(7, this)">
                                                    CATEGORY
                                                    <span></span>
                                                </label>
                                            </li>
                                    ...
                                    <div class="m-btn-group btn-group ml-1" role="group">
                                        <span data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                                            <button id="btn-export-vehicles" type="button"
        ...
        <div class="modal-dialog" role="dialog">
            <div class="modal-content">
                ...
                <div class="modal-footer">
                    <button type="button" class="btn btn-primary btnNew"
                            data-dismiss="modal">
                        Ok, I Understand.
                    </button>
                </div>
            ...
            <form>
                ...
                <div class="modal-content">
                    ...
                    <div class="modal-footer">
                        ...
                        <button class="btn btn-danger btnNew" type="button" data-dismiss="modal">Cancel</button>
                    </div>
                </div>
            </form>
        </div>
    ...
    <form id="frm-accountability-search">
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                ...
                <div class="modal-footer">
                    <button type="button" onclick="clear_acc_search()" class="btn btn-danger btnAdvance_search mr-auto">Clear</button>
                    <button type="button" id="accountability_search" class="btn btn-primary btnAdvance_search">Search</button>
    ...
    <form id="frm-advance-search">
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                ...
                <div class="modal-footer">
                    <button type="button" onclick="clear_adv_search()" class="btn btn-danger btnAdvance_search mr-auto">Clear</button>
...
<?php
    $this->load->view("vehicles/modals/print_barcode_vehicle");
?>
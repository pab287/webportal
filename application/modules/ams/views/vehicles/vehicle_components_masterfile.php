<style>
    #table-vehicle-components-master-file > thead > tr > th:first-child:after,
    #table-vehicle-components-master-file > thead > tr > th:first-child:before {
        content: "" !important;
    }
</style>
            ...
            <div class="m-portlet m-portlet--mobile">
                    ...
                    <div class="m-portlet__head-caption">
                        <div class="m-portlet__head-title">
                            <h3 class="m-portlet__head-text">
                                Vehicle Components Master file
                            </h3>
                        </div>
                    </div>
                    <div class="m-portlet__head-tools">
                        <a href="<?= base_url('ams/vehicles/archive/?type=component') ?>" class="custom-btn-link">
                ...
                <div class="m-portlet__body">
                                ...
                                <div class="form-group m-form__group row align-items-center">
                                    <div class="col-md-12">
                                        ...
                                        <button class="btn btn-primary m-btn m-btn--icon m-btn--pill btnAdvance_search"
                                                type="button"
                                                data-toggle="modal" data-target="#modal-advance-search">
                            ...
                            <div class="col-xl-4 order-1 order-xl-2 m--align-right d-flex flex-row">
                                ...
                                <div class="btn-group ml-3" role="group"
                                    ...
                                    <div class="m-btn-group btn-group ml-1" role="group">
                                        <span data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                                            <button id="btn-export-vehicle-components" type="button"
                    ...
                    <div class="m_datatable m-datatable m-datatable--default m-datatable--loaded m-datatable--scroll table-responsive-sm">
                        <table class="table table-striped table-bordered" id="table-vehicle-components-master-file"
                               width="100%">
                            <thead>
                            <tr>
                                <th>
                    ...
                    <div class="modal-body">
                        ...
                        <div class="form-group m-form__group">
                            ...
                            <textarea name="archive_remark" class="form-control m-input" id="archive-remarks-text-area"
                                      rows="3" data-validation="required"></textarea>
                        </div>
                    </div>
                    <div class="modal-footer">
                        <button class="btn btn-primary btnNew" type="submit">Archive</button>
...
<?php
    $this->load->view("modals/print_barcode_vehicle");
?>
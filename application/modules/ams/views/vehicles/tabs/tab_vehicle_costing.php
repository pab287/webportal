<div class="row">
    <div class="col-xl-8 order-2 order-xl-1">
        <button class="btn btn-success m-btn--pill btnNew" type="button"
                title="Add Costing" onclick="openNewCostingDialog()">
            ...
            <div class="m-input-icon m-input-icon--left">
                ...
                <div class="input-group">
                    <input type="search" class="form-control" placeholder="Search Here..."
                           style="height: auto;" id="search-vehicle-costing" autocomplete="off">
...
<div class="m_datatable m-datatable m-datatable--default m-datatable--loaded m-datatable--scroll mt-3 table-responsive">
    <table class="table table-striped table-bordered" id="tab-costing-table" width="100%">
        <thead>
        <tr>
            <th>DESCRIPTION</th>
            <th>PRICE</th>

<div class="row">
    <div class="col-xl-8 order-2 order-xl-1">
        <button class="btn btn-success m-btn--pill btnNew" type="button"
                title="Add New Component" data-toggle="modal" data-target="#new-vehicle-component-dialog">
            <i class="fa fa-plus"></i>
            <span class="ml-1">New</span>
        </button>
        <button class="btn btn-success m-btn--pill btnNew" type="button"
                title="Add Existing Component"
                data-toggle="modal"
            ...
            <div class="m-input-icon m-input-icon--left">
                ...
                <div class="input-group">
                    <input type="search" class="form-control" placeholder="Search Here..."
                           style="height: auto;" id="search-vehicle-components" autocomplete="off">
                    <span class="input-group-btn">
                        <button class="btn btn-secondary btnNew tab-clear-search" type="button"
                                title="Clear Search" data-placement="bottom"

...
<div class="m-content">
            ...
            <div class="m-portlet m-portlet--mobile">
                ...
                <div class="m-portlet__body">
                    <div class="row">
                        ...
                        $goback = null;
                        if ($type === "mother") {
                            $goback = base_url("ams/vehicles/vehicle_masterfile");
                        } elseif ($type === "component") {
                            $goback = base_url("ams/vehicles/vehicle_components_masterfile");
                        }
                        ?>

                        <div class="m--margin-left-15 d-flex align-items-end" style="margin-bottom: 13px;">
                            <button type="button"
                                    class="btn btn-primary m-btn m-btn--icon m-btn--icon-only m--margin-right-5 btnMass_restore btn-restore-multiple"
                                    data-toggle="m-tooltip"
                                    data-original-title="Restore Selected"
                                    data-skin="dark"
                                    data-delay='{"show": 300}'
                                    onclick="confirmRestoreSelections()"
                                    disabled>
                                <i class="la la-reply"></i>
                            </button>
                            <button type="button"
                                    class="btn btn-danger m-btn m-btn--icon m-btn--icon-only btnMass_delete btn-delete-multiple"
                                    data-toggle="m-tooltip"
                                    data-original-title="Permanently Delete Selected"
                                    data-skin="dark"
                                    data-delay='{"show": 300}'
                                    onclick="confirmDeleteSelections()"
                                    disabled>
                        ...
                        <?php } else { ?>
                            <div class="col-xl-2">
                                <div class="form-group m-form__group">
                                    ...
                                    <select class="form-control m-input" id="filterByVehicleType">
                                        <option value="all">All Types</option>
                                        <option value="mother">Vehicle</option>
                        ...
                        <div class="col"></div>
                        <div class="col-xl-3"
                             style="flex-direction: column; justify-content: flex-end; display: flex;">
                            <div class="form-group m-form__group">
                                <div class="m-input-icon m-input-icon--left">
                                    ...
                                    <div class="input-group">
                                        <input type="search" class="form-control" placeholder="Search Here..."
                                               style="height: auto;" id="search-archived-vehicles">
                    ...
                    <div class="m_datatable m-datatable m-datatable--default m-datatable--loaded m-datatable--scroll m--margin-top-20 table-responsive-sm">
                        <table class="table table-striped table-bordered" id="table-archived-vehicles" width="100%">
                            <thead>
                            <tr>
                                <th class="d-flex justify-content-center">
                                    <label class='m-checkbox'>
                                        <input type='checkbox' class='form-control'
                                               id="select-all-archived-vehicle-page">
                                        <span></span>
                                    </label>
                                </th>
                                <th>Status</th>
    ...
    <input type="hidden" value="<?= $type ?>" id="archived-vehicle-type">
</div>

<div class="modal fade" tabindex="-1" role="dialog" id="confirm-delete-archived-vehicles">
    <form id="frm-confirm-delete-archived-vehicles"
          action="<?= base_url('ams/vehicles/delete_archived_vehicles_multiple') ?>">
            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <div style="text-transform: none; font-size: 20px;">
                        Are you sure to permanently delete selected vehicles?
                    </div>
                </div>
...
<div class="modal fade" tabindex="-1" role="dialog" id="confirm-restore-vehicles-multiple">
    <form id="frm-confirm-restore-vehicles-multiple"
          action="<?= base_url('ams/vehicles/restore_archived_vehicles_multiple') ?>">

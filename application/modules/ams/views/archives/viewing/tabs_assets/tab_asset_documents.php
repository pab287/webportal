            ...
            <div class="m-input-icon m-input-icon--left">
                ...
                <div class="input-group">
                    <input type="search" class="form-control" placeholder="Search Here..."
                           style="height: auto;" id="search-asset-document" autocomplete="off">
                    <span class="input-group-btn">
                        <button class="btn btn-secondary btnArchive tab-clear-search" type="button"
                                style="border-color: #cdcdcd;" data-skin="dark"
...
<div class="m_datatable m-datatable m-datatable--default m-datatable--loaded m-datatable--scroll mt-3 table-responsive">
    <table class="table table-striped table-bordered" id="asset-viewing-documents-table" width="100%">
        <thead>
        <tr>
            <th>DESCRIPTION</th>
            <th>FILENAME</th>

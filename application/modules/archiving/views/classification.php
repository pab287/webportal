            ...
            <div class="m-portlet m-portlet--mobile">
                ...
                <div class="m-portlet__body">
                    ...
                    <div class="m_datatable m-datatable m-datatable--default m-datatable--loaded m-datatable--scroll">
                        <table class="table table-striped table-bordered" id="table-classification" width="100%">
                            <thead>
                            <tr>
                                <th>Description</th>
                                <th>Type</th>
                        ...
                        <div class="modal-dialog">
                            <div class="modal-content">
                                ...
                                <div class="modal-footer">
                                    <button type="button" onclick="delete_classification()"
                                            class="btn btn-danger m-btn m-btn--custom m-btn--icon  btnNew">Delete
                                    </button>
                ...
                <div class="modal fade" id="modal_form_classification" role="dialog">
                    <div class="modal-dialog">
                        <div class="modal-content">
                            <div class="modal-header">
                                <h3 class="modal-title"></h3>
                            ...
                            <div class="modal-body form">
                                <form action="#" id="form_classification" class="form-horizontal">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-md-12">
                                            <select id="type" name="type" data-placeholder="Enter type" class="form-control">
                            ...
                            <div class="modal-footer">
                                ...
                                <button type="submit" id="btnSave" onclick="save_classification()"

                        ...
                        <div class="modal-dialog">
                            <div class="modal-content">
                                ...
                                <div class="modal-footer">
                                    <button type="button" onclick="delete_memo()" class="btn btn-danger m-btn m-btn--custom m-btn--icon  btnNew">
                                        Delete
                                    </button>
                ...
                <div class="modal fade" id="modal_form_document" role="dialog">
                    <div class="modal-dialog">
                        <form action="#" id="form_document" class="form-horizontal" enctype="multipart/form-data"
                              onsubmit="save_memo(this); return false;">
                            <div class="modal-content">
                                <div class="modal-header">
                                    <h3 class="modal-title"></h3>
                                ...
                                <div class="modal-body">
                                    ...
                                    <input type="hidden" value="" name="current_filename"/>
                                    <input type="hidden" name="csrf_token" value="<?php echo $this->security->get_csrf_hash(); ?>">

                                    <div class="form-group">
                                        <label class="control-label">Memo Number <span class="text-danger">*</span> </label>
                                        <input type="text" name="number" id="number" placeholder="" class="form-control"
                                               data-validation="required" autocomplete="off">
                                    </div>

                                    <div class="form-group">
                                        <label class="control-label">Year <span class="text-danger">*</span> </label>
                                        <input type="text" name="year" id="year" placeholder="" class="form-control"
                                               data-validation="required" autocomplete="off">
                                    </div>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <select id="tag_id" name="tag_id[]" data-placeholder="" multiple="multiple" class="form-control"></select>
                                    </div>
                                    ...
                                    <div class="form-group mt-5">
                                        ...
                                        <span class="btn btn-success fileinput-button">
                                            ...
                                            <input id="fileupload" type="file" name="files" onchange="getFilename(this)">
                                        </span>
                                    </div>

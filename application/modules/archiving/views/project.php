                    ...
                    <div class="row align-items-center">
                        <div class="col-xl-8 order-2 order-xl-1">
                            <div class="form-group m-form__group row align-items-center">
                                <div class="col-md-4">
								<a  class="btn btn-accent m-btn m-btn--custom m-btn--icon m-btn--air m-btn--pill btnNew text-white" onclick="open_project()">
                                <span>
              ...
              <div class="modal-content">
                ...
                <div class="modal-body form">
                  <form action="#" id="form_delete" class="form-horizontal">
				   ...
				   <button type="button" onclick="delete_project()" class="btn btn-danger m-btn m-btn--custom m-btn--icon  btnNew" >Delete</button>
                ...
                <div class="modal-body form">
                  <form action="#" id="form_project" class="form-horizontal">
                   ...
                   <div class="modal-footer">
                     ...
                     <button type="submit" id="btnSave" onclick="save_project()" class="btn btn-success m-btn m-btn--custom m-btn--icon  btnNew">Save</button>

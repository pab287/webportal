            ...
            <div class="m-portlet m-portlet--mobile">
                ...
                <div class="m-portlet__body">
                    ...
                    <div class="m_datatable m-datatable m-datatable--default m-datatable--loaded m-datatable--scroll">
                        <table class="table table-striped table-bordered" id="table-tag" width="100%">
                            <thead>
                            <tr>
                                <th>Tag</th>
                                <th>Action</th>
                            ...
                            <div class="modal-dialog">
                                <div class="modal-content">
                                    ...
                                    <div class="modal-footer">
                                        <button type="button" onclick="delete_tag()" class="btn btn-primary m-btn m-btn--custom m-btn--icon  btnNew">
                                            Yes
                                        </button>
                ...
                <div class="modal fade" id="modal_form_tag" role="dialog">
                    <div class="modal-dialog">
                        <form action="#" id="form_tag" class="form-horizontal">
                            <div class="modal-content">
                                <div class="modal-header">
                                    <h3 class="modal-title"></h3>
                                    <button type="button" class="close" data-dismiss="modal" aria-label="Close"><span
                                ...
                                <div class="modal-body form">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-md-12">
                                            <input type="text" name="tag" class="form-control" data-validation="required">
                                        </div>
                                    </div>
                                </div>
                                <div class="modal-footer">
                                    <button type="submit" id="btnSave" onclick="save_tag()"

                ...
                <div class="m-form m-form--label-align-right m--margin-top-10 m--margin-bottom-10">
                    <div class="row align-items-center">
                        <div class="col-xl-8 order-2 order-xl-1">
                            <div class="form-group m-form__group row align-items-center">
                                <div class="col-md-4">
								<a  class="btn btn-accent m-btn m-btn--custom m-btn--icon m-btn--air m-btn--pill btnNew text-white" onclick="open_file()">
                                <span>
					...
					<!--begin: Datatable -->
						<div class="m_datatable m-datatable m-datatable--default m-datatable--loaded m-datatable--scroll">
							<table class="table table-striped table-bordered" id="table-file" width="100%">
								<thead>
									<tr>
										<th>Filename</th>
                                        <th>Description</th>
              ...
              <div class="modal-content">
                ...
                <div class="modal-body form">
                  <form action="#" id="form_delete" class="form-horizontal">
				   ...
				   <button type="button" onclick="delete_file()" class="btn btn-danger m-btn m-btn--custom m-btn--icon  btnNew" >Delete</button>
...
<div class="form-group">
                        ...
                        <div class="col-md-9">
                          <span class="btn btn-success fileinput-button">
                            ...
                            <input id="fileupload" type="file" name="files[]"  multiple class="">
                          </span>
...
<div class="form-group">
  ...
  <div class="col-md-12">
  <input type="text" name="description"  placeholder="" class="form-control" data-validation="required">
	...
	<div class="form-group" id="tag_text">
      <input type="text" name="tag_temp" id="tag_temp" class="form-control" maxlength="524200"data-validation="required" readonly>
                   ...
                   <div class="modal-footer">
                     ...
                     <button type="submit" id="btnSave" onclick="save_file()" class="btn btn-success m-btn m-btn--custom m-btn--icon  btnNew">Save</button>
  ...
  param_id = getUrlParameter("id");
   ...
   url : baseUrl("archiving/edit_document/") + param_id,
	  ...
	  {         
                        ...
                        var url = str + 'uploads/module/archiving/'+data.reference+'/';
                        ...
                        $('#fileupload').fileupload({
                            ...
                            dataType: 'json',
                                ...
                                $.each(data.result.files, function (index, file) {
                                  temp=$('#doc_filename').val()+'*'+file.name;
                                    //$('<p/>').text(file.name).appendTo('#files');
                                    $('#doc_filename').val(temp);
                                    $('#filename').val(temp);

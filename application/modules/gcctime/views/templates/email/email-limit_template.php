...
$header_title = ($header_title)? $header_title: "Report";
$email_content = ($email_content)? $email_content: "This a system generated email content, please disregard!";
?>
<head>
    ...
    <!-- <![endif]-->
    <title>GCCTIME - <?php echo $header_title; ?></title>
    <style type="text/css">
        body {
            width: 100%;
                            ...
                            <table border="0" align="center" width="980" cellpadding="0" cellspacing="0" class="container980">
								<tr>
                                    <td align="center" height="70" style="height:70px;">
										...
										<h2 style="font-family: Quicksand, Calibri, sans-serif; margin-top: 15px; color:#343434; text-transform: uppercase;"><?php echo $header_title; ?></h2>
                ...
                <table border="0" align="center" width="980" cellpadding="0" cellspacing="0" class="container980">
					...
					<tr>
						<td align="left" style="color: #888888; font-size: 16px; font-family: 'Work Sans', Calibri, sans-serif; line-height: 24px;">
							<div style="line-height: 24px"><?php echo $email_content; ?></div>
						</td>
					</tr>
                    <tr>

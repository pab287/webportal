...
?>
<style type="text/css">
	.m-list-timeline__items:before{background-color: unset !important;}
</style>
...
<script type="text/javascript">
            $.ajax({
       			url: "<?php echo site_url('gcctime/attendance/getAbsentToday'); ?>",
				type: "post",
				data: { csrf_token: _csrf_hash, current_date: "<?php echo $createdAt; ?>" },

...
<div class="modal fade" tabindex="-1" role="dialog"
     id="create-time-adjustment-modal">
    <form action="" id="frm-create-time-adjustment-modal" class="m-form">
        <div class="modal-dialog modal-lg" role="document">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title">CREATE TIME ADJUSTMENT</h5>
                ...
                <div class="modal-body" id="temp-create-adjustment-content">
                    ...
                    <div class="shift-details">
                            ...
                            <div class="col-xl-6 col-lg-6 col-md-6 col-sm-12">
                                ...
                                <div class="row">
                                    <div class="form-group m--font-bolder col-xl-6 col-lg-6 col-md-6 col-sm-12">
                                        ...
                                        <select name="am_in" id="am_in" class="form-control"></select>
                                    </div>
                                    <div class="form-group m--font-bolder col-xl-6 col-lg-6 col-md-6 col-sm-12">
                                        <div class="row">
                                            <div class="col-6">
                                        ...
                                        <select name="am_out" id="am_out" class="form-control"></select>
                                    </div>
                                </div>
                            </div>
                            <div class="col-xl-6 col-lg-6 col-md-6 col-sm-12">
                                ...
                                <div class="row">
                                    <div class="form-group m--font-bolder col-xl-6 col-lg-6 col-md-6 col-sm-12">
                                        ...
                                        <select name="pm_in" id="pm_in" class="form-control"></select>
                                    </div>
                                    <div class="form-group m--font-bolder col-xl-6 col-lg-6 col-md-6 col-sm-12">
                                        <div class="row">
                                            <div class="col-6">
                                        ...
                                        <select name="pm_out" id="pm_out" class="form-control"></select>
                                    </div>
                                </div>
                            </div>
                        </div>
                        <div class="row late-adjustment--container">
                            ...
                            <div class="form-group m--font-bolder col-xl-8 col-lg-8 col-md-8 col-sm-12  mb-0">
                                <div class="m-checkbox-inline">
                                    <label class="m-checkbox">
                                        <input type="radio" name="adjustment_override" value="1" /> YES<span></span>
                                    </label>
                                    <label class="m-checkbox">
                                        <input type="radio" name="adjustment_override" value="0" checked="checked"/> NO<span></span>
                                    </label>
                                </div>
                            </div>
                        </div>
                        <?php /*** temporarily remove manaul overtime request 
                        <template v-if="has_overtime === false">
                        <hr class="mt-4">
                        <div class="row">
                            <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12">
                                ...
                                <div class="row">
                                    <div class="form-group m--font-bolder col-xl-8 col-lg-8 col-md-8 col-sm-12">
                                        <div class="row">
                                            <div class="col-6">
                                                <label for="temp_overtime_in">In</label>
                                                <div class="input-group date">
                                                    <p id="temp_overtime_in" class="form-control m-input m--marginless" disabled>&nbsp;</p>
                                                ...
                                                <input type="hidden" id="overtime_in" name="overtime_in" value="" />
                                            </div>
                                            <div class="col-6">
                                                <label for="temp_overtime_out">Out</label>
                                                <div class="input-group date">
                                                    <p id="temp_overtime_out" class="form-control m-input m--marginless" disabled>&nbsp;</p>
                                                    <span class="input-group-addon m--bg-success" style="border-color: #34bfa3;" 
                                                        data-toggle="m-tooltip" 
                                                        data-original-title="Edit" 
                                                        data-skin="dark" 
                                                ...
                                                <input type="hidden" id="overtime_out" name="overtime_out" value="" />
                                            </div>
                                        </div>
                                    </div>
                                    <div class="form-group m--font-bolder col-xl-4 col-lg-4 col-md-4 col-sm-12">
                                        <div class="row">
                                            <div class="col-6">
                                                ...
                                                <input type="number" class="form-control m-input" name="overtime_reg_hrs" step="0.01" />
                                            </div>
                                            <div class="col-6">
                                                <label for="temp-ndiff_ot">N-DIFF. OT</label>
                                                <input type="number" class="form-control m-input" name="overtime_ndiff_hrs" step="0.01" />
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="row">
                                    <div class="form-group m--font-bolder col-xl-12 col-lg-12 col-md-12 col-sm-12">
                                        <label >PURPOSE</label>
                                        <textarea class="form-control m-input" rows="5" name="overtime_purpose"></textarea>
                                    </div>
                                </div>
                            </div>
                        </div>
                        ...
                        <input type="hidden" id="has-shift" name="has_shift">
                        <input type="hidden" id="emp_id" name="emp_id">
                        <input type="hidden" id="date" name="date">
                        <input type="hidden" id="dtRow">
...
<script>
    /*$('.icon-button[data-toggle="m-tooltip"]')
        .tooltip({
            container: $("#create-time-adjustment-modal")
        });*/
</script>
<div class="modal fade" tabindex="-1" role="dialog"
     id="edit-custom-shift-schedule-modal">
    <div class="modal-dialog modal-custom-shift-schedule modal-lg" role="document">
        <div class="modal-content" id="modal-edit_custom_content">
            <div class="modal-header">
                <h5 class="modal-title">Edit Customize Shift Schedule</h5>
                <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                    <span aria-hidden="true">&times;</span>
                </button>
            </div>
            <form id="frmEditCustomShift" method="post" action="<?php echo site_url("gcctime/timesheet/update_custom_shift_schedule"); ?>">
                ...
                <div class="modal-body">
                        ...
                        <div class="col-xl-4 col-lg-4 col-md-4 col-sm-12 form-group" style="min-height: 76px;">
                            ...
                            <div class="m-checkbox-inline">
                                <label class="m-checkbox">
                                    <input type="radio" name="has_shift" value="1" v-model="row.has_shift" @change="prop_shift_schedule(event)">YES <span></span>
                                </label>
                                <label class="m-checkbox">
                                    <input type="radio" name="has_shift" value="0" v-model="row.has_shift" @change="prop_shift_schedule(event)">NO <span></span>
                                </label>
                            </div>
                        </div>
                        <div class="col-xl-4 col-lg-4 col-md-4 col-sm-12 form-group" style="min-height: 76px;">
                            ...
                            <div class="input-group date" id="date-schedule">
                                ...
                                <input id="scheduled_date" name="scheduled_date" type="text" class="form-control" data-validation="required" autocomplete="off" v-model="row.scheduled_date" />
                            </div>
                        </div>
                    </div>
                    <div class="row">
                    ...
                    <div class="form-group m-form__group">
                        ...
                        <textarea name="remarks" class="form-control" data-validation="required" rows="7">{{row.remarks}}</textarea>
                    </div>
                </div>
